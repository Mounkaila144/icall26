...
return array(
    ...
    "ajaxDeleteFooter"=>array("mode"=>"json","helpers"=>array("url"=>null)),
     ...
     "ajaxSaveStamp"=>array("mode"=>"json","helpers"=>array("url"=>null)),
    
    "ajaxDeleteStamp"=>array("mode"=>"json","helpers"=>array("url"=>null)),
    
      "ajaxSaveSignature"=>array("mode"=>"json","helpers"=>array("url"=>null)),
    
      "ajaxDeleteSignature"=>array("mode"=>"json","helpers"=>array("url"=>null)),
    
    "ajaxRegistration"=>array("mode"=>"json"),
    
    "ajaxGeneratePicture"=>array("mode"=>"json","helpers"=>array("url"=>null)),
