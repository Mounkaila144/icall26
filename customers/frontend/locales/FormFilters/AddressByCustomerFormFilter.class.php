...
class AddressByCustomerFormFilter extends mfFormFilterBase {
    ...
    {                         
       $this->addDefaults(array(          
        ...
        $this->setClass('CustomerUserAddress');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ".CustomerUserAddress::getTable().               
                       " INNER JOIN ".CustomerUserAddress::getOuterForJoin('user_id').
                       " WHERE ".CustomerUserAddress::getTableField('user_id')."='{user_id}'".
                       ";"); 
       // Validators 
       $this->setValidators(array( 
            ...
            'search' => new mfValidatorSchema(array(   
                          // "name"=>new mfValidatorChoice(array("choices"=>range('A','Z'),"required"=>false)),                                                     
