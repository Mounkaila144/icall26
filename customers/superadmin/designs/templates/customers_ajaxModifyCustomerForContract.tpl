                    ...
                    <table>                       
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                ...
                                <input type="text" class="Customer" name="mobile" value="{$contract->getCustomer()->get('mobile')}"/>
                        ...
                        <tr>
                            ...
                            <td>                                                     
                                ...
                                <div><input type="text" class="CustomerAddress" size="64" name="address1" value="{$contract->getCustomer()->getAddress()->get('address1')}"/></div>
                                <div><input type="text" class="CustomerAddress" size="64" name="address2" value="{$contract->getCustomer()->getAddress()->get('address2')}"/></div>
                            </td>
                        </tr>
...
<script type="text/javascript">
    ...
    $("#ContractCustomer-Cancel").click(function(){            
       return $.ajax2({                    
                ...
                errorTarget: ".ContractCustomer-errors",
