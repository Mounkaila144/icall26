...
class CustomerFinancialBase extends mfObject2 {
     
    protected static $fields=array('customer_id','credit_used','credit_date','inprogress_credit','credit_amount','created_at','updated_at');
    const table="t_customers_financial"; 
