...
class CustomerSectorDeptForSectorFormFilter extends mfFormFilterBase {
    ...
    {                           
       ...
       $this->setClass('CustomerSectorDept');
       $this->setFields(array());
       $this->setQuery("SELECT * FROM ".CustomerSectorDept::getTable().                                                                       
                       ";"); 
       // Validators 
