...
<div>
    ...
    <a href="#" id="Tax-Cancel"><img  src="{url('/icons/cancel.gif','picture')}" alt="{__('cancel')}"/>{__('cancel')}</a>      
</div>
...
<script type="text/javascript">
     ...
     $(document).on('click','.Taxes',function() { $("#Tax-Save").show(); });
