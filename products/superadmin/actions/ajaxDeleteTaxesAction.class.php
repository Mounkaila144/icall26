...
class products_ajaxDeleteTaxesAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {      
      ...
      try 
      {
          ...
          $id=$validator->isValid($request->getPostParameter('Tax'));
          $item= new Tax($id,$site);
          $item->delete();          
        //  $this->getEventDispather()->notify(new mfEvent($item, 'taxes.change','delete')); 
          $response = array("action"=>"deleteTaxes","id" =>$id);
      } 
      catch (mfException $e) {
          $messages->addError($e);
      }
