...
class  users_ajaxSaveAttributionI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                    
        ...
        $this->form = new UserAttributionViewForm($request->getPostParameter('UserAttributionI18n'));                    
        try
        {            
            $this->item=new UserAttributionI18n($this->form->getDefault('attribution_i18n'));               
