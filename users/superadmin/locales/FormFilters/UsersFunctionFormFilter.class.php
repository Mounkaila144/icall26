...
class UsersFunctionFormFilter extends mfFormFilterBase {
    ...
    function configure()
    {                    
       $this->objects=array('UserFunctionI18n','UserFunction');
       ...
       $this->setClass('UserFunction');
       $this->setFields(array('value'=>'UserFunctionI18n'));
       $this->setQuery("SELECT {fields} FROM ".UserFunction::getTable().                      
                       " LEFT JOIN ".UserFunctionI18n::getInnerForJoin('function_id'). " AND ".UserFunctionI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
