...
class UsersTeamFormFilter extends mfFormFilterBase {
    ...
    function configure()
    {                    
       $this->objects=array("UserTeam","manager1"=>"User","manager2"=>"User");
       ...
       $this->setClass('UserTeam');       
       $this->setQuery("SELECT {fields} FROM ".UserTeam::getTable().
