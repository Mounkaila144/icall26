...
class moduleManagerAdminBase extends mfObject2 {
    ...
    protected static $fields=array('name','title','description','logo','type','version','update','is_active','created_at','updated_at',);
  ...
  function __construct($parameters=null) {
    ...
    function loadUpdate(){
        $update=end(glob(mfConfig::get('mf_modules_dir')."/".$this->getName()."/superadmin/updates/*",GLOB_ONLYDIR));
        $this->set('update',end(explode('/', $update)));  
        return $this;
    }
