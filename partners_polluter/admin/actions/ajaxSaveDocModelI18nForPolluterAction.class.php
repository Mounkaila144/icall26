...
class  partners_polluter_ajaxSaveDocModelI18nForPolluterAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                  
        ...
        $this->form = new PartnerPolluterModelDocViewForPolluterForm($request->getPostParameter('PolluterModelI18n'),$request->getFiles('PolluterModelI18n'));                    
        try
        {            
            ...
            {              
             ...
             //   var_dump($this->form['model_i18n']->hasValue('file'));
                ...
                {                                        
                    ...
                    $file->save($this->item_i18n->getFile()->getPath(),$this->item_i18n->get('file'));                                    
                    $this->item_i18n->getEngine()->process();   
                    $this->item_i18n->save();                       
                }
