...
class partners_polluter_ajaxSaveNewDocModelI18nForPolluterAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                     
        ...
        {      
            ...
            if ($this->polluter->isNotLoaded())
                    return ;
            $this->form= new PartnerPolluterModelDocNewForPolluterForm($this->getUser()->getCountry(),$request->getPostParameter('PolluterModel'));             
