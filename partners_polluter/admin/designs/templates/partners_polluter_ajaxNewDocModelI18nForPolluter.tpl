...
<h3>{__('New DOCX model for polluter [%s]',$polluter->get('name'))}</h3>
<div>
...
<table class="tab-form" cellspacing="0">
    ...
    <tr class="full-with">
      ...
      <tr class="full-with">
        <td class="label"><span>{__("DOC")}</span></td>
        <td>
      ...
      $('#PartnerPolluterModel-Save').click(function(){                             
        ...
        //      alert("Params="+params.toSource());   return ;
          ...
          return $.ajax2({ data : params,   
                           files: ".files",
                           url: "{url_to('partners_polluter_ajax',['action'=>'SaveNewDocModelI18nForPolluter'])}",
                            loading: "#tab-site-dashboard-x-settings-loading",  
                           errorTarget: ".site-errors",
                           target: "#actions"}); 
        });                
