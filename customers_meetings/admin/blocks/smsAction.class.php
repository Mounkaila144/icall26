...
class customers_meetings_smsActionComponent extends mfActionComponent {
    ...
    //   $this->user=$user->toArray();                                
       ...
       $this->getEventDispather()->notify(new mfEvent($this, 'customers.meetings.sms.build','customer'));   
    } 
