...
class customers_meetings_ajaxSaveNewStatusI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {             
        ...
        try
        {      
            $this->form= new CustomerMeetingStatusNewForm($this->getUser()->getCountry(),$request->getPostParameter('CustomerMeetingStatus'));             
            $this->customer_contract_status_i18n=new CustomerMeetingStatusI18n();
