...
class customers_meetings_ajaxLoadEmailModelI18nMeetingForSaleAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {    
       ...
       {                      
          ...
          try
          {
            $content=$this->getComponent('/customers_meetings/emailForSale', array('COMMENT'=>false,'meeting'=>$meeting,'user'=>$user,'model_i18n'=>$model_i18n))->getContent();         
          }
