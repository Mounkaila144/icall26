<?php
// www.ecosol16.net/admin/api/v2/meetings/admin/ListSale2Meeting

 
class customers_meetings_api2ListSale2MeetingAction extends mfAction {
    ...
    public function execute(\mfWebRequest $request) {
        ...
        if (!$this->getUser()->hasCredential(array(array('superadmin','api2_meeting_list_sales2'))))
