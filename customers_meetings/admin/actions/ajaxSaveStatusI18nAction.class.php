...
class  customers_meetings_ajaxSaveStatusI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                    
        ...
        $this->form = new CustomerMeetingStatusViewForm($request->getPostParameter('CustomerMeetingStatusI18n'));                    
        try
        {            
            $this->item=new CustomerMeetingStatusI18n($this->form->getDefault('status_i18n'));               
