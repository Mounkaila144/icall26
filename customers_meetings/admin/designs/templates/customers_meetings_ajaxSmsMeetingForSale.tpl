...
<div>
    <a href="#" class="btn" id="UserMeetingsSms-Send" style="display:none"><img  src="{url('/icons/save.gif','picture')}" alt="{__('send')}"/>{__('Send')}</a>   
</div>   
{if $form->isValid()}    
...
<script type="text/javascript">
    ...
    $(".UserSms").click(function() {  $("#UserMeetingsSms-Send").show(); });

{if $user}
    $("#UserMeetingsSms-Send").click(function() {  
