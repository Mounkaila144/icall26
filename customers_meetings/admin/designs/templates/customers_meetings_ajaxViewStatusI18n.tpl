...
<div>
    ...
    <a href="#" id="CustomerMeetingStatus-Cancel" class="btn"><i class="fa fa-times" style="color:#000;margin-right:10px;"></i>
  ...
  {*  <tr class="full-with">
    ...
    <tr>
     ...
     <tr class="full-with">
        ...
        <td><div id="CustomerMeetingStatus-error_name" class="error-form">{$form.status.name->getError()}</div>  
    ...
    <tr class="full-with">
        ...
        <td>          
            {if $item->isLoaded()}
                ...
                <a id="CustomerMeetingStatus-ChangeIcon" href="#"><i class="fa fa-plus" style="margin-right: 10px;"></i>{*<img  src="{url('/icons/add.gif','picture')}" alt="{__('new')}"/>*}
    ...
    <tr class="full-with">
         ...
         <td>
            <div id="CustomerMeetingStatus-error_value" class="error-form">{$form.status_i18n.value->getError()}</div>
            <input type="text" size="40" class="CustomerMeetingStatusI18n" name="value" value="{$item->get('value')}"/>    
