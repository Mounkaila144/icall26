...
class CustomerMeetingCompanyFormFilter extends mfFormFilterBase{
    ...
    {                         
       ...
       $this->setClass('CustomerMeetingCompany');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ".CustomerMeetingCompany::getTable().";"); 
       // Validators 
