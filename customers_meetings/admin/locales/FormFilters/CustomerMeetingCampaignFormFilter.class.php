...
class CustomerMeetingCampaignFormFilter extends mfFormFilterBase {
    ...
    {                    
       ...
       $this->setClass('CustomerMeetingCampaign');
       $this->setFields(array());
       $this->setQuery("SELECT * FROM ".CustomerMeetingCampaign::getTable().                                                                       
                       ";"); 
       // Validators 
