...
class CustomersMeetingTypeFormFilter extends mfFormFilterBase {
    ...
    function configure()
    {                   
       $this->objects=array('CustomerMeetingTypeI18n','CustomerMeetingType');
       ...
       $this->setClass('CustomerMeetingType');
       $this->setFields(array('value'=>'CustomerMeetingTypeI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerMeetingType::getTable().                      
