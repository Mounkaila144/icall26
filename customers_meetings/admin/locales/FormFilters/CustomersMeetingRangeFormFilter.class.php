...
class CustomersMeetingRangeFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerMeetingRange');
       $this->setFields(array('value'=>'CustomerMeetingRangeI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerMeetingRange::getTable().                      
                       " LEFT JOIN ".CustomerMeetingRangeI18n::getInnerForJoin('range_id'). " AND ".CustomerMeetingRangeI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
