...
class CustomerMeetingsConfirmedDuplicateFormFilter extends mfFormFilterBase {
    ...
    {                          
       ...
       $this->setQuery("SELECT {fields} FROM ".CustomerMeeting::getTable().                      
                       ...
                       " WHERE ". CustomerMeeting::getTableField('id')."!='{meeting_id}' AND ". Customer::getTableField('phone')."='{phone}' AND ".CustomerMeeting::getTableField('is_confirmed')."='YES'".
