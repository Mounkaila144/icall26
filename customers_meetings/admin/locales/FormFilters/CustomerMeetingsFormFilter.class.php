...
class CustomerMeetingsFormFilter extends mfFormFilterBase {
   ...
   //    var_dump($this->conditions->debug());
       ...
       $this->setValidators(array( 
          ...
          /* 'begin' => new mfValidatorSchema(array(                                
            ...
            'equal' => new mfValidatorSchema(array(                              
                              ...
                              "state_id"=>new mfValidatorChoice(array("choices"=>array(""=>"","0"=>__("-- Not affected --"))+CustomerMeetingUtils::getStatusForSelect($this->getLanguage(),$this->getConditions()),"key"=>true,"required"=>false)),
            ...
            'nbitemsbypage'=>new mfValidatorChoice(array("required"=>false,"choices"=>array("5"=>"5","10"=>"10","20"=>"20","30"=>"30","50"=>"50","100"=>"100","250"=>"250"),"key"=>true)),                    
        ));    
     ...
     /*  if ($this->getSettings()->hasCallcenter() && $this->getUser()->getGuardUser()->hasCallcenter())
       ...
       mfContext::getInstance()->getEventManager()->notify(new mfEvent($this, 'meeting.filter.config'));  
    ...
    {
        return $this->status_states=$this->status_states===null?CustomerMeetingStatus::getStatusForSelect()->unshift(array("0"=>__("Not defined"))):$this->status_states;
    }
    
    function getStatusCallStates()
    {
        return $this->status_call=$this->status_call===null?CustomerMeetingStatusCall::getStatusCallForSelect()->unshift(array("0"=>__("Not defined"))):$this->status_call;
    }
}
