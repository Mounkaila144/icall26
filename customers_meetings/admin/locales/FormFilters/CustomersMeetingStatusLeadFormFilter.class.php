...
class CustomersMeetingStatusLeadFormFilter extends mfFormFilterBase {
    ...
    function configure()
    {                   
       $this->objects=array('CustomerMeetingStatusLeadI18n','CustomerMeetingStatusLead');
       ...
       $this->setClass('CustomerMeetingStatusLead');
       $this->setFields(array('value'=>'CustomerMeetingStatusLeadI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerMeetingStatusLead::getTable().                      
