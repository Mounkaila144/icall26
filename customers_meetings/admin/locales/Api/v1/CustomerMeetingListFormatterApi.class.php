...
require_once __DIR__."/FormFilters/CustomerMeetingApiFormFilter.class.php";
require_once __DIR__."/Formatters/CustomerMeetingItemFormatterApi.class.php";

class CustomerMeetingListFormatterApi  extends mfFormatterActionApi{
    ...
    {   
        ...
        {
            $this->loadTheme();            
            $this->formFilter= new CustomerMeetingApiFormFilter($this->getUser());              
