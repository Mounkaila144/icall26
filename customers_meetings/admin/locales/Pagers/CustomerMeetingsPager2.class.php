...
class CustomerMeetingsPager2 extends Pager {
  ...
  /*  function __construct($classes)
    ...
    */
     ...
     function __construct(CustomerMeetingsFormFilter2 $filter)
    {               
       $this->filter=$filter;       
    ...
    {                         
       ...
       {                               
          ...
          /*    if ($items->hasCustomerMeetingStatusI18n())
           ...
           //  mfContext::getInstance()->getEventManager()->notify(new mfEvent($items, 'meetings.list.pager2.item',array('item'=>$item)));                                            
       ...
       mfContext::getInstance()->getEventManager()->notify(new mfEvent($this, 'meetings.list.pager2'));       
    }
