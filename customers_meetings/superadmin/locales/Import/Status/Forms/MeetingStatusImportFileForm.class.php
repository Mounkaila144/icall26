...
class MeetingStatusImportFileForm extends mfFormSite {
    ...
    function configure() { 
        $this->setValidators(array(      
          //  'file'=>new mfValidatorFile(array('max_size'=>500000,'mime_types'=>array( 'text/plain','text/csv', 'text/comma-separated-values')))
            ...
            'ftp'=>new mfValidatorFileForImport(array('path'=>Site::getFtpDirectory('/imports/meetings/status',$this->getSite()),'mime_types'=>array('application/zip'))),
                ));
