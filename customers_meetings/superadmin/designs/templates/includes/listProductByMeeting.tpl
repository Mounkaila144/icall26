<div>
            <a href="#" class="btn" id="{$site->getSiteID()}-CustomerMeetings-NewMeetingProduct" title="{__('new product')}" ><img  src="{url('/icons/new.gif','picture')}" alt="{__('new')}"/>{__('New product')}</a>
</div>
...
<script type="text/javascript">
       ...
       $(".CustomerMeetings-ViewProduct").click( function () {                           
        ...
        $("#{$site->getSiteID()}-CustomerMeetings-NewMeetingProduct").click( function () {                           
            return $.ajax2({     
