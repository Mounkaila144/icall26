...
class customers_meetings_ajaxNewStatusCallI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {              
        ...
        $this->form= new CustomerMeetingStatusCallNewForm((string)$form['lang'],array(),$this->site);
        $this->customer_contract_status_i18n=new CustomerMeetingStatusCallI18n(array('lang'=>(string)$form['lang']),$this->site);        
    }
