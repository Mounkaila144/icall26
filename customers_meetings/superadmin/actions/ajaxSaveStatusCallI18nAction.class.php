...
class  customers_meetings_ajaxSaveStatusCallI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {             
        ...
        $this->form = new CustomerMeetingStatusCallViewForm($request->getPostParameter('CustomerMeetingStatusCallI18n'),$this->site);                    
        try
        {            
            $this->item=new CustomerMeetingStatusCallI18n($this->form->getDefault('status_i18n'),$this->site);               
