...
class CustomerMeetingRangeI18nBase extends mfObjectI18n {
     
    protected static $fields=array('value','range_id','lang','created_at','updated_at');
    const table="t_customers_meetings_date_range_i18n"; 
    protected static $foreignKeys=array('range_id'=>'CustomerMeetingRange'); // By default
  ...
  /*  protected function loadByEmail($email)
     ...
     function getRange()
    {
       if (!$this->_range_id)
       {
          $this->_range_id=new CustomerMeetingRange($this->get('range_id'),$this->getSite());          
       }   
