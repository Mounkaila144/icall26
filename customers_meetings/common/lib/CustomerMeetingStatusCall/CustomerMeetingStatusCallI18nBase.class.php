...
class CustomerMeetingStatusCallI18nBase extends mfObjectI18n {
     
    protected static $fields=array('value','status_id','lang','created_at','updated_at');
    const table="t_customers_meeting_status_call_i18n"; 
    protected static $foreignKeys=array('status_id'=>'CustomerMeetingStatusCall'); // By default
  ...
  /*  protected function loadByEmail($email)
     ...
     function getStatus()
    {
       if (!$this->_status_id)
       {
          $this->_status_id=new CustomerMeetingStatusCall($this->get('status_id'),$this->getSite());          
       }   
