...
class ProductItemMasterForProductFormFilter extends mfFormFilterBase {
...
//                       " GROUP BY ".ProductItemsItem::getTableField('item_slave_id').  
//                       ";"
                       "SELECT {fields} FROM ".ProductItem::getTable().                            
                       " LEFT JOIN ".ProductItem::getOuterForJoin('tva_id').
                       " INNER JOIN ". ProductItemsItem::getInnerForJoin('item_master_id').
                       //" WHERE ".ProductItem::getTableField('product_id')."='{product_id}'". 
                       " INNER JOIN ".
                       "(SELECT ".ProductItem::getTableField('id').
                       " FROM ".ProductItem::getTable().
                       " WHERE ".ProductItem::getTableField('product_id')."='{product_id}')".
                       " AS tmp ON tmp.id=".ProductItemsItem::getTableField('item_master_id'). 
                       " GROUP BY ".ProductItemsItem::getTableField('item_slave_id').  
                       ";"                              
                );
                echo $this->getQuery();
