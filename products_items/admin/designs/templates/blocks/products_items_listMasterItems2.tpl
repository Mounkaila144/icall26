...
{*            <a href="#" title="{__('Edit')}" class="ProductItemMaster-View" id="{$item->get('id')}">
            ...
            <a href="#" title="{__('Edit')}" class="ProductItemListMaster-View" id="{$item->get('id')}">
                 <i class="fa fa-edit" style="margin-right:10px;color: orange;"></i></a>    
...
<script type="text/javascript">
	 ...
	 function changeItemState(resp) 
        ...
        function updateSitePager(n)
        {
         ...
         $(".ProductItemListMaster-View").click( function () {                    
