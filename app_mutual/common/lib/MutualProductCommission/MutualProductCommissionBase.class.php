...
class MutualProductCommissionBase extends mfObject2 {
    
    protected static $fields=array('mutual_product_id','from','to','rate','started_at','ended_at','is_active','status','created_at','updated_at');
    const table="t_app_mutual_commission"; 
    ...
    function getFormatter()
    {
        if($this->formatter===null)
            $this->formatter= new MutualProductCommissionFormatter($this);
