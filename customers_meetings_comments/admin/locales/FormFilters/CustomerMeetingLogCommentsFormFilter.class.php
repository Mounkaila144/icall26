...
class CustomerMeetingLogCommentsFormFilter extends mfFormFilterBase {
    ...
    {                   
       ...
       $this->setQuery("SELECT {fields} FROM ".CustomerMeetingCommentHistory::getTable().                      
                       ...
                       " WHERE ".CustomerMeetingComment::getTableField('meeting_id')."={meeting_id} AND ".CustomerMeetingComment::getTableField('type')."='LOG'".
                       ";"); 
       // Validators 
