...
class SystemMenuBase extends SystemMenuCore {
...
//            {
//               //  echo "<pre>"; var_dump($elm); //  echo "</pre>";
//            }    
//            die(__METHOD__); 
          
             foreach ($this->getSystemMenus()->getAll()->byName() as $item){             
                 //echo "<br>".$item->get('name');
                       ...
                       if($child->get('type')=="USER")
                        {
                           //  echo "<br>"."E1";
                            ...
                            //  echo "<br>"."E2-".$child->get('name');
                            // var_dump($this->menu_manager->search($child->get('name')));
...
//       die();
        ...
        $this->deleteNotInChildrenByNames($menu_names); 
           //  //  echo "<pre>--test"; var_dump($this->menu_manager->getChildren());echo "</pre>";
