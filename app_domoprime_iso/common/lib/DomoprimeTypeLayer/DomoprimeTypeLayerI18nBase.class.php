...
class DomoprimeTypeLayerI18nBase extends mfObjectI18n {
     
    protected static $fields=array('value','type_id','lang','created_at','updated_at');
    const table="t_domoprime_iso_type_layer_i18n"; 
    protected static $foreignKeys=array('type_id'=>'DomoprimeTypeLayer'); // By default
    ...
    function __construct($parameters=null,$site=null) {
      ...
      if (is_array($parameters)||$parameters instanceof ArrayAccess)
      {
          if (isset($parameters['lang']) && isset($parameters['type_id']))
              return $this->loadByLangAndTypeLayerId((string)$parameters['lang'],(string)$parameters['type_id']); 
  ...
  /*  protected function loadByEmail($email)
    ...
    {       
     ...
     protected function loadByLangAndTypeLayerId($lang,$type_id)
    {
     ...
     function getType()
    {
       if (!$this->_type_id)
       {
          $this->_type_id=new DomoprimeTypeLayer($this->get('type_id'),$this->getSite());          
       }   
