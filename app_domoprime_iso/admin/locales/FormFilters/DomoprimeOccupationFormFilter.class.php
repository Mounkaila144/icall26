...
class DomoprimeOccupationFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('DomoprimeOccupation');
       $this->setFields(array('value'=>'DomoprimeOccupationI18n'));
       $this->setQuery("SELECT {fields} FROM ".DomoprimeOccupation::getTable().                      
                       " LEFT JOIN ".DomoprimeOccupationI18n::getInnerForJoin('occupation_id'). " AND ".DomoprimeOccupationI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
