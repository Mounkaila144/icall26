...
class DomoprimeRequestFormFilter extends mfFormFilterBase {
    ...
    {                          
       ...
       $this->setClass('DomoprimeCustomerRequest');
    ...
    /*   $this->setQuery("SELECT {fields} FROM ".DomoprimeRequest::getTable().  
                       " LEFT JOIN ".DomoprimeRequest::getOuterForJoin('creator_id').  
                       " INNER JOIN ".DomoprimeRequest::getOuterForJoin('customer_id').  
                       " LEFT JOIN ".DomoprimeRequest::getOuterForJoin('contract_id').  
                       ";"); */
       
       $this->_query->select("{fields}")
                     ->from(DomoprimeCustomerRequest::getTable())                  
                     ->inner(DomoprimeCustomerRequest::getOuterForJoin('contract_id'))
                     ->inner(CustomerContract::getOuterForJoin('customer_id'))
               ;
