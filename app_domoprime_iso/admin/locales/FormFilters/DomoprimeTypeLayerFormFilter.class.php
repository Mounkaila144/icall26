...
class DomoprimeTypeLayerFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('DomoprimeTypeLayer');
       $this->setFields(array('value'=>'DomoprimeTypeLayerI18n'));
       $this->setQuery("SELECT {fields} FROM ".DomoprimeTypeLayer::getTable().                      
                       " LEFT JOIN ".DomoprimeTypeLayerI18n::getInnerForJoin('type_id'). " AND ".DomoprimeTypeLayerI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
