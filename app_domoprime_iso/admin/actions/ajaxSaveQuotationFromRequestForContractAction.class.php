...
class app_domoprime_iso_ajaxSaveQuotationFromRequestForContractAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {              
        ...
        if ($this->form->isValid())
        {
            ...
            $this->forward($this->getModuleName(), 'ajaxListPartialQuotationFromRequestForContract');
        }   
        else
        {
