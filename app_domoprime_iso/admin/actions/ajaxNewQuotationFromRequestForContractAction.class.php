...
class app_domoprime_iso_ajaxNewQuotationFromRequestForContractAction extends mfAction {
    
       
     const forward='ajaxListPartialQuotationFromRequestForContract';
    ...
    function execute(mfWebRequest $request) {              
        ...
        if ($this->form->isValid())
        {
            ...
            $request->addRequestParameter('contract', $this->contract);
             ...
             $this->getEventDispather()->notify(new mfEvent($this->quotation, 'contract.quotation.new'));
