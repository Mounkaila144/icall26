...
class app_domoprime_iso_ajaxListPartialQuotationFromRequestForViewContractAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {
        ...
        DomoprimeQuotation::loadNumberOfQuotationsForContract($this->contract);      
         $this->last_quotation=new DomoprimeQuotation($this->contract);
         $this->is_from_new=$request->getRequestParameter('is_from_new',false);
    }
