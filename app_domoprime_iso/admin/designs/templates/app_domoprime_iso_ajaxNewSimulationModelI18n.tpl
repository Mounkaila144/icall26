...
<table class="tab-form" cellpadding="0" cellspacing="0">
    <tr class="full-with">
        ...
        <td>
            ...
            <img class="SimulationModelI18n" id="{$form.model_i18n.lang}" name="lang" src="{url("/flags/`$form.model_i18n.lang`.png","picture")}" title="{if !$form.model_i18n.lang->getError()}{format_country($form.model_i18n.lang)}{/if}" />
...
<script type="text/javascript">
     ...
     $('#SimulationModel-Cancel').click(function(){              
      ...
      $('#SimulationModel-Save').click(function(){                             
            var  params= {         
                                DomoprimeSimulationModel: { 
                                   model_i18n : { lang: $(".SimulationModelI18n[name=lang]").attr('id')  },
                                   model : { },
                                   token :'{$form->getCSRFToken()}'
                                } };
          $("input.SimulationModelI18n,textarea.SimulationModelI18n").each(function() { params.DomoprimeSimulationModel.model_i18n[this.name]=$(this).val(); });
          $("input.SimulationModel").each(function() {  params.DomoprimeSimulationModel.model[this.name]=$(this).val();  });  // Get foreign key  
        //      alert("Params="+params.toSource());   return ;          
          return $.ajax2({ data : params,                        
                           url: "{url_to('app_domoprime_iso_ajax',['action'=>'SaveNewSimulationModelI18n'])}",
                           errorTarget: ".site-errors",
                           target: "#actions"}); 
        });  
