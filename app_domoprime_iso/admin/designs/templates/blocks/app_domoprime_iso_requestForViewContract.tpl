 ...
 <fieldset>
                ...
                {if $form->iso->hasValidator('number_of_people')}
                 <tr>
                    ...
                    <td> 
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input red-input" name="number_of_people" value="{format_number($iso->get('number_of_people'),"#")}" />                        
                    </td>                  
                </tr>
                {/if}
                 ...
                 <tr>
                    ...
                    <td> 
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="number_of_children" value="{format_number($iso->get('number_of_children'),"#")}"/>                         
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('revenue')}
                 <tr>
                    ...
                    <td>  
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input red-input" name="revenue" value="{format_number($iso->get('revenue'),"#.00")}" />                        
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('number_of_fiscal')}
                 <tr>
                    ...
                    <td>     
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input red-input" name="number_of_fiscal" value="{format_number($iso->get('number_of_fiscal'),"#")}" />                      
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('tax_credit_used')}
                 <tr>
                    ...
                    <td>  
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="tax_credit_used" value="{format_number($iso->get('tax_credit_used'),"#.00")}"/>                       
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('declarants')}
                 <tr>
                    ...
                    <td>   
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="declarants" value="{$iso->get('declarants')}"/>                         
                    </td>                  
                </tr>
                {/if}
         </table>
         ...
         <table> 
                ...
                <tr>
                    ...
                    <td>   
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input red-input" name="surface_top" value="{format_number($iso->get('surface_top'),"#")}" />  {if $iso->get('src_surface_top')}({format_number($iso->get('src_surface_top'),"#")}){/if}
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('surface_top')}
                <tr>
                    ...
                    <td>     
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input red-input" name="surface_wall" value="{format_number($iso->get('surface_wall'),"#")}" />{if $iso->get('src_surface_wall')}({format_number($iso->get('src_surface_wall'),"#")}){/if}                         
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('surface_floor')}
                 <tr>
                    ...
                    <td>   
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input red-input" name="surface_floor" value="{format_number($iso->get('surface_floor'),"#")}" /> {if $iso->get('src_surface_floor')}({format_number($iso->get('src_surface_floor'),"#")}){/if}
                    </td>                  
                </tr>
                {/if}
                ...
                <tr>
                    ...
                    <td>     
                        ...
                        {html_options  class="CustomerContractIso-`$contract->get('id')` Select red-input" name="energy_id" options=$form->iso.energy_id->getOption('choices') selected=$iso->get('energy_id')}                         
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('occupation_id')}
                 <tr>
                    ...
                    <td>     
                        ...
                        {html_options class="CustomerContractIso-`$contract->get('id')` Select" name="occupation_id" options=$form->iso.occupation_id->getOption('choices') selected=$iso->get('occupation_id')}                         
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('more_2_years')}
                 <tr>
                    ...
                    <td>     
                        ...
                        {html_options class="CustomerContractIso-`$contract->get('id')` Select" name="more_2_years" options=$form->iso.more_2_years->getOption('choices') selected=$iso->get('more_2_years')}                         
                    </td>                  
                </tr>                
                {/if}
                ...
                <tr>
                    ...
                    <td>     
                        ...
                        {html_options class="CustomerContractIso-`$contract->get('id')` Select" name="layer_type_id" options=$form->iso.layer_type_id->getOption('choices') selected=$iso->get('layer_type_id')}                         
                    </td>                  
                </tr>               
                {/if} 
                {if $form->iso->hasValidator('parcel_surface')}
                 <tr>
                    ...
                    <td>   
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input red-input" name="parcel_surface" value="{format_number($iso->get('parcel_surface'),"#")}" />                         
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('parcel_reference')}
                 <tr>
                    ...
                    <td>   
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input red-input" name="parcel_reference" value="{$iso->get('parcel_reference')}" />                                                 
                    </td>                  
                </tr>
                {/if}
         </table>
         ...
         <table style="width:100%;"> 
                ...
                <tr>
                    ...
                    <td>   
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="install_surface_top" value="{format_number($iso->get('install_surface_top'),"#")}"/>                     
                    </td>                  
                </tr>
                {/if}
                ...
                <tr>
                    ...
                    <td>     
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="install_surface_wall" value="{format_number($iso->get('install_surface_wall'),"#")}"/>                    
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('install_surface_floor')}
                 <tr>
                    ...
                    <td>   
                        ...
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="install_surface_floor" value="{format_number($iso->get('install_surface_floor'),"#")}"/>                         
                    </td>                  
                </tr>
                {/if}
         </table>
    ...
    {*<table class="tab-form">
                ...
                <tr>
                    ...
                    <td>   
                        <div class="error-form">{$form.iso.surface_top->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="surface_top" value="{format_number($iso->get('surface_top'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('surface_top')}
                <tr>
                    ...
                    <td>     
                        <div class="error-form">{$form.iso.surface_wall->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="surface_wall" value="{format_number($iso->get('surface_wall'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('surface_floor')}
                 <tr>
                    ...
                    <td>   
                        <div class="error-form">{$form.iso.surface_floor->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="surface_floor" value="{format_number($iso->get('surface_floor'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('number_of_people')}
                 <tr>
                    ...
                    <td> 
                        <div class="error-form">{$form.iso.number_of_people->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="number_of_people" value="{format_number($iso->get('number_of_people'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                 {if $form->iso->hasValidator('number_of_children')}
                 <tr>
                    ...
                    <td> 
                        <div class="error-form">{$form.iso.number_of_children->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="number_of_children" value="{format_number($iso->get('number_of_children'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('revenue')}
                 <tr>
                    ...
                    <td>  
                         <div class="error-form">{$form.iso.revenue->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="revenue" value="{format_number($iso->get('revenue'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('number_of_fiscal')}
                 <tr>
                    ...
                    <td>     
                         <div class="error-form">{$form.iso.number_of_fiscal->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="number_of_fiscal" value="{format_number($iso->get('number_of_fiscal'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('energy_id')}
                <tr>
                    ...
                    <td>     
                         <div class="error-form">{$form.iso.energy_id->getError()}</div>
                        {html_options class="CustomerContractIso-`$contract->get('id')` Select" name="energy_id" options=$form->iso.energy_id->getOption('choices') selected=$iso->get('energy_id')}                         
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('occupation_id')}
                ...
                <tr>
                    ...
                    <td>   
                        <div class="error-form">{$form.iso.install_surface_top->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="install_surface_top" value="{format_number($iso->get('install_surface_top'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('install_surface_wall')}
                <tr>
                    ...
                    <td>     
                        <div class="error-form">{$form.iso.install_surface_wall->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="install_surface_wall" value="{format_number($iso->get('install_surface_wall'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('install_surface_floor')}
                 <tr>
                    ...
                    <td>   
                        <div class="error-form">{$form.iso.install_surface_floor->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="install_surface_floor" value="{format_number($iso->get('install_surface_floor'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                 {if $form->iso->hasValidator('parcel_surface')}
                 <tr>
                    ...
                    <td>   
                        <div class="error-form">{$form.iso.parcel_surface->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="parcel_surface" value="{format_number($iso->get('parcel_surface'),"#.00")}"/>
                    </td>                  
                </tr>
                {/if}
                {if $form->iso->hasValidator('parcel_reference')}
                 <tr>
                    ...
                    <td>   
                        <div class="error-form">{$form.iso.parcel_reference->getError()}</div>
                        <input type="text" class="CustomerContractIso-{$contract->get('id')} Input" name="parcel_reference" value="{$iso->get('parcel_reference')}"/>
                    </td>                  
                </tr>
                {/if}
                 {if $form->iso->hasValidator('declarants')}
...
<script type="text/javascript">
      ...
      $(".CustomerContractIso-{$contract->get('id')}").click(function() { $("#CustomerContract-Save-{$contract->get('id')}").show(); });
         
      $(".CustomerContractIso-{$contract->get('id')}").change(function() { $("#CustomerContract-Save-{$contract->get('id')}").show(); } );
    
      $("#CustomerContract-Save-{$contract->get('id')}").on('parameters',function (event,params) { 
             params.Contract.iso= { };
             $(".CustomerContractIso-{$contract->get('id')}.Select option:selected").each( function () { params.Contract.iso[$(this).parent().attr('name')]=$(this).val(); } );
             $(".CustomerContractIso-{$contract->get('id')}.Input").each( function () { params.Contract.iso[$(this).attr('name')]=$(this).val(); });                   
      });
</script>    
{/if}