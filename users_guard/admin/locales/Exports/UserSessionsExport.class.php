...
class UserSessionsExport extends ExportCsvFilterBase{
    ...
    {                               
        $db=mfSiteDatabase::getInstance()
                ->setParameters(array())
                ->setObjects(array('Session','User','UserGroup','Group'))
    ...
    function getName()
    {
         return __("users-sessions")."-".date("Y-m-d")."-".md5(session_id()).".csv";
    }
