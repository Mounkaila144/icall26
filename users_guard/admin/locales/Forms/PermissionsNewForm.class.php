...
class PermissionNewForm extends mfForm {
   ...
   static $groups=array();
    ...
    function configure() { 
        ...
        $this->validatorSchema->setPostValidator(new mfValidatorPermissionExists($this->getDefaults(),array()));
    }
}
...
class permissionsNewForm extends mfForm {
    ...
    function configure() { 
        ...
        $this->embedFormForEach('collection',new PermissionNewForm(array(),array()),$this->getDefault('count')); 
