...
// www.ecosol16.net/admin/api/v2/customers/meeting/forms/admin/HoldForms


class customers_meetings_forms_api2HoldFormsAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {             
        ...
        if (!$this->getUser()->hasCredential(array(array('superadmin', 'api2_hold'))))
