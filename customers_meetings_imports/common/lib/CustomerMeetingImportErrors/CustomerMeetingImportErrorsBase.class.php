...
class CustomerMeetingImportErrorsBase extends mfObject2 {
    
    protected static $fields=array('import_id','line','file','error_text','status','created_at','updated_at');
    const table="t_customers_meeting_import_errors"; 
    protected static $foreignKeys=array('import_id'=>'CustomerMeetingImportFile',
                                        );  
    ...
    {
//        echo "<pre>"; var_dump($import); echo "</pre>";
    ...
    function getImport()
    {
        if (!$this->_import_id)
        {
            $this->_import_id=new CustomerMeetingImportFile($this->get('import_id'));
        }    
