...
class CustomerMeetingImportErrorsFormFilter extends mfFormFilterBase {
    ...
    {                   
       ...
       $this->setClass('CustomerMeetingImportErrors');
       $this->setFields(array());
       $this->setQuery("SELECT * FROM ".CustomerMeetingImportErrors::getTable(). 
