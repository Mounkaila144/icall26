...
class CustomerMeetingImportFormatFormFilter extends mfFormFilterBase {
    ...
    {                   
       ...
       $this->setClass('CustomerMeetingImportFormat');
       $this->setFields(array());
       $this->setQuery("SELECT * FROM ".CustomerMeetingImportFormat::getTable().                                            
                       ";"); 
       // Validators 
