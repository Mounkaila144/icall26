...
class CustomerMeetingImportGoogleSheetFormatFormBase extends mfForm {
    ...
    function configure()
    {
        $this->form=new CustomerMeetingImportForm();
        $this->setValidators(array(
            "name"=>new mfValidatorString(array('required' => true,'empty_value' => false)),
            "file"=>new mfValidatorString(array('required' => true,'empty_value' => false)),
            "filename"=>new mfValidatorString(array('required' => true,'empty_value' => false)),
            "leaf"=>new mfValidatorString(array('required' => true,'empty_value' => false)),
        ));
