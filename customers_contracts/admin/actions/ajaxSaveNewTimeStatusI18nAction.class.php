...
class customers_contracts_ajaxSaveNewTimeStatusI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {             
        ...
        try
        {      
            $this->form= new CustomerContractTimeStatusNewForm($this->getUser()->getCountry(),$request->getPostParameter('CustomerContractTimeStatus'));             
            $this->item_i18n=new CustomerContractTimeStatusI18n();
            $this->form->bind($request->getPostParameter('CustomerContractTimeStatus'),$request->getFiles('CustomerContractTimeStatus'));
