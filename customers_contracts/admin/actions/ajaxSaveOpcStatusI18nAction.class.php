...
class  customers_contracts_ajaxSaveOpcStatusI18nAction extends mfAction {
    
   
        
    function execute(mfWebRequest $request) {                    
        $messages = mfMessages::getInstance();     
        $this->form = new CustomerContractOpcStatusViewForm($request->getPostParameter('CustomerContractOpcStatusI18n'));                    
        try
        {            
            $this->item_i18n=new CustomerContractOpcStatusI18n($this->form->getDefault('status_i18n'));               
            $this->form->bind($request->getPostParameter('CustomerContractOpcStatusI18n'),$request->getFiles('CustomerContractOpcStatusI18n'));                            
