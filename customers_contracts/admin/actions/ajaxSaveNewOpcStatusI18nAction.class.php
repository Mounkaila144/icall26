...
class customers_contracts_ajaxSaveNewOpcStatusI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {             
        ...
        try
        {      
            $this->form= new CustomerContractOpcStatusNewForm($this->getUser()->getCountry(),$request->getPostParameter('CustomerContractOpcStatus'));             
            $this->item_i18n=new CustomerContractOpcStatusI18n();
            $this->form->bind($request->getPostParameter('CustomerContractOpcStatus'),$request->getFiles('CustomerContractOpcStatus'));
