...
class customers_contracts_ajaxLoadSmsModelI18nContractAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {    
       ...
       {                   
          ...
          $model_i18n=new CustomerModelSmsI18n($request->getPostParameter('CustomerModelSmsI18n'));        
          if ($model_i18n->isNotLoaded())           
              throw new mfException(__("Model is invalid."));
          try
          {
            $content=$this->getComponent('/customers_contracts/sms', array('COMMENT'=>false,'contract'=>$contract,'model_i18n'=>$model_i18n))->getContent();         
          }
