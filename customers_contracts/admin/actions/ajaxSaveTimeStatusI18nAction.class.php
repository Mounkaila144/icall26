...
class  customers_contracts_ajaxSaveTimeStatusI18nAction extends mfAction {
    
   
        
    function execute(mfWebRequest $request) {                    
        $messages = mfMessages::getInstance();     
        $this->form = new CustomerContractTimeStatusViewForm($request->getPostParameter('CustomerContractTimeStatusI18n'));                    
        try
        {            
            $this->item_i18n=new CustomerContractTimeStatusI18n($this->form->getDefault('status_i18n'));               
            $this->form->bind($request->getPostParameter('CustomerContractTimeStatusI18n'),$request->getFiles('CustomerContractTimeStatusI18n'));                            
