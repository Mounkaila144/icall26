...
class  customers_contracts_ajaxSaveStatusI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                    
        ...
        $this->form = new CustomerContractStatusViewForm($request->getPostParameter('CustomerContractStatusI18n'));                    
        try
        {            
            $this->item=new CustomerContractStatusI18n($this->form->getDefault('status_i18n'));               
