...
class CustomerContractTimeStatusNewForm extends mfForm {
    ...
    function configure()
    {
        ...
        $this->embedForm('status_i18n', new CustomerContractTimeStatusI18nBaseForm($this->getDefault('status_i18n')));
