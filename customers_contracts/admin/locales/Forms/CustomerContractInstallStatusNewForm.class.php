...
class CustomerContractInstallStatusNewForm extends mfForm {
    ...
    function configure()
    {
        ...
        $this->embedForm('status_i18n', new CustomerContractInstallStatusI18nBaseForm($this->getDefault('status_i18n')));
