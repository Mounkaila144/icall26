...
class CustomersContractInstallStatusFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerContractInstallStatus');
       $this->setFields(array('value'=>'CustomerContractInstallStatusI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerContractInstallStatus::getTable().                      
                       " LEFT JOIN ".CustomerContractInstallStatusI18n::getInnerForJoin('status_id'). " AND ".CustomerContractInstallStatusI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
