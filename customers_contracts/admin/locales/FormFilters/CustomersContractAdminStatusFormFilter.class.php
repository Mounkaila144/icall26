...
class CustomersContractAdminStatusFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerContractAdminStatus');
       $this->setFields(array('value'=>'CustomerContractAdminStatusI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerContractAdminStatus::getTable().                      
                       " LEFT JOIN ".CustomerContractAdminStatusI18n::getInnerForJoin('status_id'). " AND ".CustomerContractAdminStatusI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
