...
class CustomersContractOpcStatusFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerContractOpcStatus');
       $this->setFields(array('value'=>'CustomerContractOpcStatusI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerContractOpcStatus::getTable().                      
                       " LEFT JOIN ".CustomerContractOpcStatusI18n::getInnerForJoin('status_id'). " AND ".CustomerContractOpcStatusI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
