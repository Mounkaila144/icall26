...
class CustomerContractZoneFormFilter extends mfFormFilterBase{
    ...
    {                         
       ...
       $this->setClass('CustomerContractZone');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ".CustomerContractZone::getTable().";"); 
       // Validators 
       $this->setValidators(array( 
            ...
            'search' => new mfValidatorSchema(array(   
                          ...
                          //  "link"=>new mfValidatorString(array("required"=>false)),                            
                            ...
                            "postcodes"=>new mfValidatorString(array("required"=>false)), 
                            ),array("required"=>false)),                             
