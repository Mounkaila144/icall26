...
class CustomersContractRangeFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerContractRange');
       $this->setFields(array('value'=>'CustomerContractRangeI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerContractRange::getTable().                      
