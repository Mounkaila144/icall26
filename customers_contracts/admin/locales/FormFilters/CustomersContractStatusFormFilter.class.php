...
class CustomersContractStatusFormFilter extends mfFormFilterBase {
    ...
    function configure()
    {                   
       $this->objects=array('CustomerContractStatusI18n','CustomerContractStatus');
       ...
       $this->setClass('CustomerContractStatus');
       $this->setFields(array('value'=>'CustomerContractStatusI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerContractStatus::getTable().                      
