...
class CustomersContractTimeStatusFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerContractTimeStatus');
       $this->setFields(array('value'=>'CustomerContractTimeStatusI18n'));
       $this->setQuery("SELECT {fields} FROM ".CustomerContractTimeStatus::getTable().                      
                       " LEFT JOIN ".CustomerContractTimeStatusI18n::getInnerForJoin('status_id'). " AND ".CustomerContractTimeStatusI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
