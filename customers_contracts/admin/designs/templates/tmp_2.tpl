    ...
    {/foreach}
      ...
      <div class="pageSuivante cadreDevis pageCompteur" style="">
        ...
        <div class="infoClient" style="">
          ...
          <div class="" >{$customer.gender} {$customer.lastname|upper} {$customer.firstname|upper}1{$verifs.0.number|upper}</div>
  ...
  <div class="header">
      ...
      <div class="container" style="" >
            ...
            <thead class="theadProduit" >
              <th style="width:60%;">DETAILS{$test}</th>
       ...
       <script>
               ...
               /*  $(document).ready(function(){ 
                 $("#regTitle").html("Hello World");
                  ...
                  var total =table.getElementsByTagName('tbody')[0].offsetHeight/2300;
                  ...
                  //   document.getElementById("total").innerHTML+=j;
                     ...
                     mytable.createTBody();
                        ...
                        for(i = 0; i < rows.length; i++) {
                               ...
                               height_of_rows +=rows[i].offsetHeight ;                           
                               if(height_of_rows>2300)
                               {
