    ...
    <table class="tab-form" id="Company-form" cellpadding="0" table-column="2" cellspacing="0">
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="name" value="{$item->get('name')|escape}" size="30"/>{if $form->name->getOption('required')}*{/if}
             {__("Type")}
     ...
     <tr>
         ...
         <td>
            ...
            <input type="text" class="Company Input" name="commercial" value="{$item->get('commercial')|escape}" size="30"/>{if $form->commercial->getOption('required')}*{/if}
         </td>
     </tr>
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="web" value="{$item->get('web')|escape}" size="30"/>{if $form->web->getOption('required')}*{/if}
         </td>
     </tr>
     <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="email" value="{$item->get('email')|escape}" size="30"/>{if $form->email->getOption('required')}*{/if}
         </td>             
     </tr>  
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="address1" value="{$item->get('address1')|escape}" size="30" />{if $form->address1->getOption('required')}*{/if}
         </td>             
     </tr>   
  {*   <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="address2" value="{$item->get('address2')|escape}" size="30" />{if $form->getValidator('address2')->getOption('required')}*{/if}
         </td>             
     </tr> *}  
     <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="postcode" value="{$item->get('postcode')|escape}" size="10" />{if $form->postcode->getOption('required')}*{/if}
         </td>             
     </tr>    
     <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="city" value="{$item->get('city')|escape}" size="30"/>{if $form->city->getOption('required')}*{/if}
     ...
     <tr>
         ...
         <td> 
             ...
             {select_country name="country" class="Company Input" selected=$item->get('country')}
         </td> 
     </tr>    
         ...
         <td>
           {* <span id="pictureFilename">{if $item->get("picture")}[{$item->get('picture')}]{/if}</span>*}
            ...
            <div id="pictureForm" style="display:none">
                  <input id="pictureFile" type="file" name="CustomerContractCompany[picture]"/> 
     ...
     <tr>
         ...
         <td>
            ...
            <div id="headerForm" style="display:none">
                  <input id="headerFile" type="file" name="CustomerContractCompany[header]"/> 
     ...
     <tr> 
         ...
         <td>
            ...
            <div id="footerForm" style="display:none">           
                  <input id="footerFile" type="file" name="CustomerContractCompany[footer]"/>                   
     ...
     <tr>
         ...
         <td>                      
            ...
            <div id="stampForm" style="display:none">
                  <input id="stampFile" type="file" name="CustomerContractCompany[stamp]"/> 
     ...
     <tr>
         ...
         <td>                      
            ...
            <div id="signatureForm" style="display:none">
                  <input id="signatureFile" type="file" name="CustomerContractCompany[signature]"/> 
     ...
     <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="phone" value="{$item->get('phone')|escape}" size="30"/>{if $form->phone->getOption('required')}*{/if}
         </td>             
     </tr>  
     <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="mobile" value="{$item->get('mobile')|escape}" size="30"/>{if $form->mobile->getOption('required')}*{/if}
         </td>             
     </tr>           
     <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="fax" value="{$item->get('fax')|escape}" size="30" />{if $form->fax->getOption('required')}*{/if}
         </td>             
     </tr>  
  {*    <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="coordinates" value="{$item->get('coordinates')|escape}" size="30"/>{if $form->coordinates->getOption('required')}*{/if}
         </td>             
     </tr>   *}  
     <tr>
         ...
         <td>
            ...
            <input type="text" class="Company Input" name="ape" value="{$item->get('ape')|escape}" size="30"/>{if $form->ape->getOption('required')}*{/if} 
         </td>
     </tr>
      <tr>
         ...
         <td>
            ...
            <input type="text" class="Company Input" name="siret" value="{$item->get('siret')|escape}" size="30"/>{if $form->siret->getOption('required')}*{/if} 
         </td>
     </tr>
       <tr>
         ...
         <td>
            ...
            <input type="text" class="Company Input" name="rcs" value="{$item->get('rcs')|escape}" size="30"/>{if $form->rcs->getOption('required')}*{/if} 
         </td>
     </tr>
      <tr>
         ...
         <td>
            ...
            <input type="text" class="Company Input" name="tva" value="{$item->get('tva')|escape}" size="30"/>{if $form->tva->getOption('required')}*{/if} 
         </td>
     </tr>
      <tr>
         ...
         <td>
            ...
            <input type="text" class="Company Input" name="rge" value="{$item->get('rge')|escape}" size="30"/>{if $form->rge->getOption('required')}*{/if} 
         </td>
      </tr>
         <tr>
         ...
         <td>
            ...
            <input type="text" class="Company Input" name="capital" value="{$item->get('capital')|escape}" size="30"/>{if $form->capital->getOption('required')}*{/if} 
         </td>
     </tr>
        ...
        <tr>
         ...
         <td>
            ...
            <textarea rows="2" cols="80" class="Company Input" name="comments">{$item->get('comments')|escape}</textarea>{if $form->comments->getOption('required')}*{/if} 
         </td>
     </tr>
       <tr>
         <td class="label">{__("Footer text")}
         </td>
         <td>
             <div {if $form.footer_text->hasError()}class="error_form"{/if}>{$form.footer_text->getError()}</div> 
            <textarea rows="2" cols="80" class="Company Input" name="footer_text">{$item->get('footer_text')|escape}</textarea>{if $form->footer_text->getOption('required')}*{/if} 
         </td>
     </tr>
           ...
           <tr id="{$name}" {if $name=="tva" && $form->hasValidator('autoentreprise') && $item->isAutoEnterprise()}style="display:none"{/if} class="registration">
               ...
               <td>
                   ...
                   {else}     
                           ...
                           <input type="text" class="Company Input" name="{$name}" value="{$item->get($name)|escape}"/>   
     ...
     <td> 
      ...
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="firstname" value="{$item->get('firstname')|escape}" size="30"/>{if $form->firstname->getOption('required')}*{/if}
         </td>
     </tr>
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="lastname" value="{$item->get('lastname')|escape}" size="30"/>{if $form->lastname->getOption('required')}*{/if}
         </td>
     </tr>
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="function" value="{$item->get('function')|escape}" size="30"/>{if $form->function->getOption('required')}*{/if}
         </td>
     </tr>
      </table>
</fieldset>
<fieldset>
    <h3>{__('Second contact')}</h3>
      <table class="tab-form"  cellpadding="0" table-column="2" cellspacing="0">            
      <tr>
          <td class="label">{__("Firstname")}</td>
         <td> 
             <div  {if $form.firstname1->hasError()}class="error_form"{/if}>{$form.firstname1->getError()}</div> 
             <input type="text" class="Company Input" name="firstname1" value="{$item->get('firstname1')|escape}" size="30"/>{if $form->firstname1->getOption('required')}*{/if}
         </td>
     </tr>
      <tr>
          <td class="label">{__("Lastname")}</td>
         <td> 
             ...
             <input type="text" class="Company Input" name="lastname1" value="{$item->get('lastname1')|escape}" size="30"/>{if $form->lastname1->getOption('required')}*{/if}
         </td>
     </tr>
      <tr>
          <td class="label">{__("Function")}</td>
         <td> 
             ...
             <input type="text" class="Company Input" name="function1" value="{$item->get('function1')|escape}" size="30"/>{if $form->function1->getOption('required')}*{/if}
         </td>
     </tr>
      </table>
</fieldset>
<script type="text/javascript">
        ...
        $('#Company-Cancel').click(function(){ return $.ajax2({ url:"{url_to('customers_contracts_ajax',['action'=>'ListPartialCompany'])}",
        ...
        $('#Company-Save').click(function(){ 
                  ...
                  $("input.Company,textarea.Company").each(function() { params.CustomerContractCompany[this.name]=$(this).val(); });                     
                  $("input.Company[type=radio]:checked").each(function() { params.CustomerContractCompany[this.name]=$(this).val(); }); 
                  $(".Company.Select option:selected").each(function() { params.CustomerContractCompany[$(this).parent().attr('name')]=$(this).val(); }); 
                  if ($("[name=autoentreprise]").length)
                        params.Company.autoentreprise= $("[name=autoentreprise]").is(":checked")?"YES":"NO";  
                //     alert("params="+params.toSource()); return ;
                  return $.ajax2({ data : params,
                                   files: ".files",
                                   url: "{url_to('customers_contracts_ajax',['action'=>'SaveCompany'])}",
                                   loading: "#tab-site-dashboard-x-settings-loading",
       ...
       {* =========================== PICTURE ============================================================================= *}  
          $("#pictureUpload").click(function () { 
             return $.ajax2({ data : { CustomerContractCompany : { id: "{$item->get('id')}", token : "{mfForm::getToken('CustomerContractCompanyPictureForm')}" } },
                              files: "#pictureFile",
                              url: "{url_to('customers_contracts_ajax',['action'=>'SavePictureCompany'])}",
          ...
          $('#pictureDelete').click(function(){ 
                  ...
                  return $.ajax2({ data : { CustomerContractCompany:'{$item->get("id")}' }, 
                                   url: "{url_to('customers_contracts_ajax',['action'=>'DeletePictureCompany'])}",
                                   success :function(response) {
          ...
          $("#headerUpload").click(function () { 
             return $.ajax2({ data : { CustomerContractCompany : { id: "{$item->get('id')}", token : "{mfForm::getToken('CustomerContractCompanyHeaderForm')}" } },
                              files: "#headerFile",
                              url: "{url_to('customers_contracts_ajax',['action'=>'SaveHeaderCompany'])}",
         ...
         $('#headerDelete').click(function(){ 
                  ...
                  return $.ajax2({ data : { CustomerContractCompany:'{$item->get("id")}' }, 
                                   url: "{url_to('customers_contracts_ajax',['action'=>'DeleteHeaderCompany'])}",
                                   success :function(response) {
          ...
          $("#footerUpload").click(function () { 
             return $.ajax2({ data : { CustomerContractCompany : { id: "{$item->get('id')}", token : "{mfForm::getToken('CustomerContractCompanyFooterForm')}" } },
                              files: "#footerFile",
                              url: "{url_to('customers_contracts_ajax',['action'=>'SaveFooterCompany'])}",
         ...
         $('#footerDelete').click(function(){ 
                  ...
                  return $.ajax2({ data : { CustomerContractCompany:'{$item->get("id")}' }, 
                                   url: "{url_to('customers_contracts_ajax',['action'=>'DeleteFooterCompany'])}",
                                   success :function(response) {
          ...
          $("#stampUpload").click(function () { 
             return $.ajax2({ data : { CustomerContractCompany : { id: "{$item->get('id')}", token : "{mfForm::getToken('CustomerContractCompanyStampForm')}" } },
                              files: "#stampFile",
                              url: "{url_to('customers_contracts_ajax',['action'=>'SaveStampCompany'])}",
          ...
          $('#stampDelete').click(function(){ 
                  ...
                  return $.ajax2({ data : { CustomerContractCompany:'{$item->get("id")}' }, 
                                   url: "{url_to('customers_contracts_ajax',['action'=>'DeleteStampCompany'])}",
                                   success :function(response) {
          ...
          $("#signatureUpload").click(function () { 
             return $.ajax2({ data : { CustomerContractCompany : { id: "{$item->get('id')}", token : "{mfForm::getToken('CustomerContractCompanySignatureForm')}" } },
                              files: "#signatureFile",
                              url: "{url_to('customers_contracts_ajax',['action'=>'SaveSignatureCompany'])}",
          ...
          $('#signatureDelete').click(function(){ 
                  ...
                  return $.ajax2({ data : { CustomerContractCompany:'{$item->get("id")}' }, 
                                   url: "{url_to('customers_contracts_ajax',['action'=>'DeleteSignatureCompany'])}",
                                   success :function(response) {
