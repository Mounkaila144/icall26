  ...
  {*   <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td>           
            <div id="pictureForm">
                  <input id="pictureFile" type="file" class="files" name="CustomerContractCompany[picture]"/>
            </div>    
        </td>
    </tr>  
      ...
      <tr>
        ...
        <td>           
            <div id="headerForm">
                  <input id="headerFile" type="file" class="files" name="CustomerContractCompany[header]"/> 
            </div>    
        </td>
    </tr>  
      ...
      <tr>
        ...
        <td>           
            <div id="footerForm">
                  <input id="footerFile" type="file" class="files" name="CustomerContractCompany[footer]"/> 
            </div>    
        </td>
    </tr>         
      ...
      <tr>
        ...
        <td>           
            <div id="stampForm">
                  <input id="stampFile" type="file" class="files" name="CustomerContractCompany[stamp]"/>
            </div>    
        </td>
    </tr>  
      ...
      <tr>
        ...
        <td>           
            <div id="signatureForm">
                  <input id="signatureFile" type="file" class="files" name="CustomerContractCompany[signature]"/>
            </div>    
        </td>
    </tr>  
     ...
     <td> 
      ...
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="firstname" value="{$item->get('firstname')|escape}" size="30"/>{if $form->getValidator('name')->getOption('required')}*{/if}
         </td>
     </tr>
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="lastname" value="{$item->get('lastname')|escape}" size="30"/>{if $form->getValidator('name')->getOption('required')}*{/if}
         </td>
     </tr>
      <tr>
         ...
         <td> 
             ...
             <input type="text" class="Company Input" name="function" value="{$item->get('function')|escape}" size="30"/>{if $form->getValidator('name')->getOption('required')}*{/if}
         </td>
     </tr>
      </table>
</fieldset>
       ...
       {* =========================== PICTURE ============================================================================= *}  
         ...
         $('#headerDelete').click(function(){ 
          ...
          $("#footerUpload").click(function () { 
             return $.ajax2({ data : { CustomerContractCompany : { id: "{$item->get('id')}", token : "{mfForm::getToken('CompanyFooterForm')}" } },
                              files: "#footerFile",
         ...
         $('#footerDelete').click(function(){ 
          ...
          $("#stampUpload").click(function () { 
             return $.ajax2({ data : { CustomerContractCompany : { id: "{$item->get('id')}", token : "{mfForm::getToken('CompanyStampForm')}" } },
                              files: "#stampFile",
