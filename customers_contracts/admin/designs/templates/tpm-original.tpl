...
<head>
  ...
  .cpiTableauTraveau td {
    ...
    <div class="pageSuivante cadreDevis" style="">
      ...
      <div class="" style="margin-top: -50px;height:1450px;">
        <table class="tableProduit" style="width:94%;align: center;margin-left:auto;margin-right:auto;height:100%">
          <tr style="height:4%">
            <th class="" style="width:70%;background: #cae3ad;font-size:23px;text-align: center;font-weight:bold;">DETAILS</th>
...
{if $items@index == 0}
              ...
              <div class="" style="font-size:17px;text-align:left;vertical-align:top;text-transform: uppercase;background: #fcfcfc;padding-left:10px;padding-top:8px;"><span style="">
                 BAR-TH-164 : Rénovation globale d’une maison individuelle
                      <br> Etude n° <span style="color:blue;">{$contract.forms.TH164.NumeroEtude}</span> réalisée le <span style="color:blue;">{$contract.forms.TH164.DateEtude}</span> par la
                    société <span style="color:blue;">{$contract.forms.TH164.NomEtudeEnergetique}</span> dont le SIRET est <span style="color:blue;">{$contract.forms.TH164.SirenEtudeEnergetique}</span>
                      avec le logiciel <span style="color:blue;">{$contract.forms.TH164.NomLogiciel}</span>
                    Version <span style="color:blue;">{$contract.forms.TH164.VersionLogiciel}</span> date du <span style="color:blue;">{$contract.forms.TH164.DateLogiciel}</span>
                    de la société <span style="color:blue;">{$contract.forms.TH164.NomEditeurLOGICIEL}</span><br>
                    • La formule de calcul est : (Cef initial - Cef projet) X Surf hab X Coeff bonification coup pouce<br>
                    • Type de logement : maison individuelle, surface habitable <span style="color:blue;">{$contract.request.surface_home}</span>(Surf hab)<br>
                    • Mode de chauffage avant travaux : <span style="color:blue;">{$contract.request.previous_energy.value}</span><br>
                    • Consommation conventionnelle en énergie primaire Cep (kWh/m².an) : <span style="color:blue;">{$contract.request.cep}</span>
                    (Cep initial),  <span style="color:blue;">{$contract.request.cep_project}</span> (Cep projet)<br>
                    • Consommation conventionnelle en énergie final Cef (kWh/m².an) :  <span style="color:blue;">{$contract.request.cef}</span> (Cef initial),
                     <span style="color:blue;">{$contract.request.cef_project}</span> (Cef projet)<br>
                    • Gain énergétique du projet par rapport à la consommation conventionnelle en énergie primaire avant travaux: <span style="color:blue;">{$contract.forms.TH164.GAINENERGETIQUE}</span><br>
                    • Coefficient d'utilisation d'énergie renouvelable ou de récupération après travaux :
                  <br>  supérieur ou égal à <span style="color:blue;">{$contract.forms.TH164.CoefficientEnergie}</span><br>
                    • Coefficient de bonification coup de pouce (Coeff bonification coup pouce) : <span style="color:blue;">{$contract.forms.TH164.Bonification}</span><br>
                    • Les émissions de gaz à effet de serre après rénovation sont inférieures ou égales à la valeur initiale de ces émissions avant travaux<br>
                    • Travaux incluant le changement de tous les équipements de chauffage ou de production d'eau chaude sanitaire au charbon ou au fuel non performants (toutes
                    technologies autre qu'à condensation)

                  </span></div>


                </td><td class="" style="vertical-align:top;font-size:19px;"><div style="background:  #f2f2f2;margin-top:12px;"> </div> </td>
                <td class="" style="vertical-align:top;font-size:19px;"><div style="background:  #f2f2f2;margin-top:12px;"></div> </td>
                <td class="" style="vertical-align:top;font-size:19px;"><div style="background:  #f2f2f2;margin-top:12px;"> </div> </td>
                <td class="" style="text-align: center;font-size:19px;vertical-align:top;"><div style="background:  #f2f2f2;margin-top:12px;"></div>
                </td>
              </tr>
    {/if}
{/if}
  <tr>
      <td class="" style="vertical-align:top;">
              <div class="" style="font-size:17px;text-align:left;vertical-align:top;background: #f2f2f2;text-transform: uppercase;text-align:center;margin-top:12px;"><span style="">référence: </span>{$items.item.input1}</div>
              <div class="" style="font-size:17px;text-align:left;vertical-align:top;text-transform: uppercase;background: #fcfcfc;padding-left:10px;padding-top:10px;"><span style="">désignation: </span>{eval $items.item.description}</div>

            </td><td class="" style="vertical-align:top;font-size:17px;"><div style="background:  #f2f2f2;margin-top:12px;"> {$items.rate_tax}</div> </td>
            <td class="" style="vertical-align:top;font-size:17px;w"><div style="background:  #f2f2f2;margin-top:12px;">{$items.quantity|upper} </div> </td>
            <td class="" style="vertical-align:top;font-size:17px"><div style="background:  #f2f2f2;margin-top:12px;">{$items.sale_price_without_tax|upper} </div> </td>
            <td class="" style="text-align: center;font-size:17px;vertical-align:top;"><div style="background:  #f2f2f2;margin-top:12px;">{$items.total_sale_price_without_tax|upper}</div>
            </td>
          </tr>
          {/if}
          {/foreach}
      ...
      <tr>
            ...
            <div class="" style="margin-left:auto;margin-right:auto;position:relative;;width:94%;margin-top:40px;">
              <div class="" style="height:260px">
                ...
                <table class="Montant" style="width:70%;text-align:center;">
                  <tr style="background-color:#b4d863;">
                ...
                <div class="" style="margin-top:60px;">
                  ...
                  <table class="Montant" style="width:100%;;text-align:center;">
            ...
            <div class="" style="margin-left:400px;margin-top:100px">
              ...
              <div style="border:solid 1px black;width:720px;height:270px;margin-left:30px;border-radius:6px;  ">
                ...
                <footer class="footerAllPage">
                  ...
                  {$nbrPage=$nbrPage+1}
                  <div class="numberOfPage" style="margin-top:-40px;">{$nbrPage}/{$totalPage+1}</div>
              ...
              <div style="border:solid 1px black;width:720px;height:270px;margin-left:auto;margin-right:auto;margin-top:60px">
                ...
                <div class=" cadreDevis pageSuivante" >
                  ...
                  <div class="content" style="">
                    ...
                    {if $items.item.input1=="Condition generale"}
                                  ...
                                  <td style="width:220px;font-familly:'Arial';font-size:16px;vertical-align:top;text-align:justify;padding:7px;color: #000;">
                                    ...
                                    <div class="pageSuivante cadreCondition"  style="color: #000;">
                                      ...
                                      {if $polluter.picture != null}<div style="display:inline;width:100%;position:absolute;left: 4px;">
                                        ...
                                        <div style="background: #d4edfb;width: 510px;height:200px;left: 120px;text-align: center;padding: 3px;margin-right:auto;margin-left:auto;">
