...
class CustomerContractBase extends mfObject2 {
  ...
  /*  function ($fields = null) {
   ...
   /* function getStates()
    ...
    {
                $this->general_fields=new ServiceApplicationHookSchemaExportModelFieldCollection(array(        
            'contract_in_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','in_at',array('format_date'=>"d")),
            'contract_meeting_id'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','meeting_id'),
            'contract_in_at_hhmm'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','in_at',array('format_date'=>"q")),
            'contract_in_at_ddmmyyyyhhmm'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','in_at',array('format_date'=>array('d','q'))),
            'contract_created_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','created_at',array('format_date'=>array("d","q"))),
            'contract_created_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','created_at',array('format_date'=>'a')),
            'contract_created_at_ddmmmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','created_at',array('format_date'=>'a')),
            'contract_opc_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opc_at',array('format_date'=>'a')),
            'contract_opc_at_tomorrow_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opc_at',array('format_date'=>'a','method'=>'getOpcAtNextDay')),
            'contract_opc_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opc_at',array('format_date'=>'a')),
            'contract_opc_at_dd-mm-yyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opc_at',array('format_date'=>"d-M-y")),
          //  'contract_opc_at_ddmmmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opc_at',array('format_date'=>'a')),
            'contract_opened_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opened_at',array('format_date'=>array("d"))),
            'contract_opened_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opened_at',array('format_date'=>'a')),
            'contract_opened_at_ddmmmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opened_at',array('format_date'=>'a')),
            'contract_opened_at_dd-mm-yyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','opened_at',array('format_date'=>"d-M-y")),
          
            'contract_customer_id'=>new ServiceApplicationHookSchemaExportModel('Customer','id'), 
            'contract_customer'=>new ServiceApplicationHookSchemaExportModel('Customer',array('lastname','firstname'),array("tpl"=>"{firstname} {lastname}","string"=>"upper","trim"=>" ")),           
            'contract_customer_lastname'=>new ServiceApplicationHookSchemaExportModel('Customer','lastname',array("string"=>"upper","trim"=>" ")),             
            'contract_customer_firstname'=>new ServiceApplicationHookSchemaExportModel('Customer','firstname',array("string"=>"upper","trim"=>" ")),             
            'contract_customer_email'=>new ServiceApplicationHookSchemaExportModel('Customer','email',array("trim"=>" ")),             
            'contract_customer_email_empty'=>new ServiceApplicationHookSchemaExportModel('Customer','email',array("trim"=>" ","default"=>__('NEANT'))),         
            'contract_remarks'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','remarks',array("string"=>"upper")), 
            'contract_customer_address'=>new ServiceApplicationHookSchemaExportModel('CustomerAddress',array('address1','address2'),array("tpl"=>"{address1} {address2}","string"=>"upper")), 
            'contract_customer_address_postcode'=>new ServiceApplicationHookSchemaExportModel('CustomerAddress','postcode',array("string"=>"upper")), 
            'contract_customer_address_dept'=>new ServiceApplicationHookSchemaExportModel('CustomerAddress','postcode',array("method"=>"getDept","string"=>"upper")), 
            'contract_customer_address_city'=>new ServiceApplicationHookSchemaExportModel('CustomerAddress','city',array("string"=>"upper")), 
            'contract_customer_mobile'=>new ServiceApplicationHookSchemaExportModel('Customer','mobile',array("string"=>"upper")), 
            'contract_customer_phone'=>new ServiceApplicationHookSchemaExportModel('Customer','phone',array("string"=>"upper")), 
            'contract_customer_gender'=>new ServiceApplicationHookSchemaExportModel('Customer','gender',array("string"=>"upper")), 
            'contract_creator'=>new ServiceApplicationHookSchemaExportModel('Creator',array('firstname','lastname'),array("tpl"=>"{firstname} {lastname}","string"=>"upper")), 
            'contract_treated_at'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','treated_at',array('format_date'=>'a')),
         //   'contract_confirmed_at'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','confirmed_at',array('format_date'=>'a')),
            'contract_is_qualified'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','is_qualified',array('i18n'=>true,"string"=>"upper")),
            'contract_is_confirmed'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','is_confirmed',array('i18n'=>true,"string"=>"upper")),
            'contract_status'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','status',array('i18n'=>true,"string"=>"upper")),  
            'contract_telepro'=>new ServiceApplicationHookSchemaExportModel('Telepro',array('firstname','lastname'),array("tpl"=>"{firstname} {lastname}","string"=>"upper")), 
            'contract_assistant'=>new ServiceApplicationHookSchemaExportModel('Assistant',array('firstname','lastname'),array("tpl"=>"{firstname} {lastname}","string"=>"upper")), 
            'contract_team'=>new ServiceApplicationHookSchemaExportModel('UserTeam','name',array("string"=>"upper")), 
            'contract_sale1'=>new ServiceApplicationHookSchemaExportModel('Sale1',array('firstname','lastname'),array("tpl"=>"{firstname} {lastname}","string"=>"upper")), 
            'contract_sale2'=>new ServiceApplicationHookSchemaExportModel('Sale2',array('firstname','lastname'),array("tpl"=>"{firstname} {lastname}","string"=>"upper")), 
            'contract_state'=>new ServiceApplicationHookSchemaExportModelI18n('CustomerContractStatus','value',array("string"=>"upper")),
            'contract_opc_status'=>new ServiceApplicationHookSchemaExportModelI18n('CustomerContractOpcStatus','value',array("string"=>"upper")),
            'contract_campaign'=>new ServiceApplicationHookSchemaExportModelI18n('CustomerContractCampaign','name',array("string"=>"upper")),
            'contract_callcenter'=>new ServiceApplicationHookSchemaExportModel('Callcenter','name',array("string"=>"upper")),
            'contract_products'=>new ServiceApplicationHookSchemaExportModelField('products',array("string"=>"upper")),           
            'contract_product_reference'=>new ServiceApplicationHookSchemaExportModel('Product','reference',array("string"=>"upper")), 
            'contract_product_meta_title'=>new ServiceApplicationHookSchemaExportModel('Product','meta_title',array("string"=>"upper")), 
            'contract_product_meta_description'=>new ServiceApplicationHookSchemaExportModel('Product','meta_description',array("string"=>"upper")), 
            'contract_internal_reference'=>new CustomerContractFormatVirtualReferenceExportModel(), 
            'contract_internal_reference_id'=>new CustomerContractFormatVirtualReference2ExportModel(), 
            'contract_id'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','id'),            
            'contract_reference'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','reference',array("string"=>"upper")),
            'contract_sav_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','sav_at',array('format_date'=>array("d"))),
            'contract_sav_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','sav_at',array('format_date'=>'a')),
            'contract_sav_at_ddmmmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','sav_at',array('format_date'=>'a')),
            'contract_sav_at_dd-mm-yyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','sav_at',array('format_date'=>'d-M-y')),
            'contract_opc_at_range'=>new ServiceApplicationHookSchemaExportModelI18n('CustomerContractRange','value',array("string"=>"upper")),
            'contract_polluter_name'=>new ServiceApplicationHookSchemaExportModel('PartnerPolluterCompany','name',array("string"=>"upper")),
            'contract_polluter_commercial'=>new ServiceApplicationHookSchemaExportModel('PartnerPolluterCompany','commercial',array("string"=>"upper")),
            'contract_polluter_address2'=>new ServiceApplicationHookSchemaExportModel('PartnerPolluterCompany','address2',array("string"=>"upper")),
            'contract_admin_status'=>new ServiceApplicationHookSchemaExportModelI18n('CustomerContractAdminStatus','value',array("string"=>"upper")),
            'contract_time_status'=>new ServiceApplicationHookSchemaExportModelI18n('CustomerContractTimeStatus','value',array("string"=>"upper")),
            'contract_doc_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','doc_at',array('format_date'=>'a')),            
            'contract_doc_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','doc_at',array('format_date'=>'a')),
            'contract_doc_at_dd-mm-yyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','doc_at',array('format_date'=>"d-M-y")),
            
            'contract_pre_meeting_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','pre_meeting_at',array('format_date'=>"d")),
            'contract_pre_meeting_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','pre_meeting_at',array('format_date'=>'a')),
            'contract_pre_meeting_at_ddmmmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','pre_meeting_at',array('format_date'=>'a')),
            'contract_pre_meeting_at_ddmmmmyyyyhhmm'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','pre_meeting_at',array('format_date'=>array('d','q'))),
            'contract_pre_meeting_at_dd-mm-yyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','pre_meeting_at',array('format_date'=>"d-M-y")),
            'contract_partner_layer_name'=>new ServiceApplicationHookSchemaExportModel('PartnerLayerCompany','name',array("string"=>"upper")),         
            'contract_partner_layer_siret'=>new ServiceApplicationHookSchemaExportModel('PartnerLayerCompany','siret',array("string"=>"upper")),         
            'contract_partner_layer_siret9'=>new ServiceApplicationHookSchemaExportModel('PartnerLayerCompany','siret',array("string"=>"upper","max_lenght"=>9)),  
            
            'contract_partner_layer_rge_start_at'=>new ServiceApplicationHookSchemaExportModel('PartnerLayerCompany','rge_start_at',array('format_date'=>'a')),   
            'contract_partner_layer_rge_end_at'=>new ServiceApplicationHookSchemaExportModel('PartnerLayerCompany','rge_end_at',array('format_date'=>'a')),   
            
            'contract_closed_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','closed_at',array('format_date'=>array("d","q"))),
            'contract_closed_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','closed_at',array('format_date'=>'a')),   
            
            'contract_quoted_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','quoted_at',array('format_date'=>array("d"))),
            'contract_quoted_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','quoted_at',array('format_date'=>'a')),
            'contract_quoted_at_ddmmmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','quoted_at',array('format_date'=>'a')),
            'contract_quoted_at_dd-mm-yyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','quoted_at',array('format_date'=>"d-M-y")),
            
            'contract_billing_at_ddmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','billing_at',array('format_date'=>array("d"))),
            'contract_billing_at_ddmmyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','billing_at',array('format_date'=>'a')),
            'contract_billing_at_ddmmmmyyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','billing_at',array('format_date'=>'a')),
            'contract_billing_at_dd-mm-yyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','billing_at',array('format_date'=>"d-M-y")),
            
            'contract_company_name'=>new ServiceApplicationHookSchemaExportModel('CustomerContractCompany','name',array("string"=>"upper")), 
            'contract_campaign_name'=>new ServiceApplicationHookSchemaExportModel('CustomerMeetingCampaign','name',array("string"=>"upper")), 
            'contract_payment_at_dd-mm-yyyy'=>new ServiceApplicationHookSchemaExportModel('CustomerContract','payment_at',array('format_date'=>"d-M-y")),                       
            
        ));
        $this->fields=clone $this->general_fields;
        
    }
    
    static function DeleteContractsWithNoCustomer($site=null)
    {
         $db=mfSiteDatabase::getInstance()
            ->setParameters(array())
