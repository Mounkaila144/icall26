...
class CustomerContractTimeStatusI18nBase extends mfObjectI18n {
     
    protected static $fields=array('value','status_id','lang','created_at','updated_at');
    const table="t_customers_contracts_time_status_i18n"; 
    protected static $foreignKeys=array('status_id'=>'CustomerContractTimeStatus'); // By default
  ...
  /*  protected function loadByEmail($email)
     ...
     function getStatus()
    {
       if (!$this->_status_id)
       {
          $this->_status_id=new CustomerContractTimeStatus($this->get('status_id'),$this->getSite());          
       }   
