...
class CustomerContractAdminStatusBase extends mfObject2 {
     
    protected static $fields=array('name','icon','color');
    const table="t_customers_contracts_admin_status"; 
  ...
  /*  protected function loadByEmail($email)
    ...
    {
        return mfConfig::get('mf_sites_dir')."/".$this->getSiteName()."/frontend/view/data/customers/contracts/admin_status/".$this->get('id');
    }  
    /* =================================== P I C T U R E =========================================== */
    ...
    public function getIcon()
    {
      ...
      {    
         $this->_icon=new PictureObject2(array(
                 ...
                 "urlPath"=>url("/nocache/data/customers/contracts/admin_status/".$this->get('id')."/","web","frontend"),
                 "url"=>url("/nocache/data/customers/contracts/admin_status/".$this->get('id')."/".$this->get('icon'),"web","frontend")
              ));
      }
      return $this->_icon;     
    }
    ...
    static function getName($name)
    {
     ...
     public function getI18n($lang=null)
     {
         ...
         if ($this->i18n===null)
         {
             ...
             $this->i18n=new CustomerContractAdminStatusI18n(array('lang'=>$lang,"status_id"=>$this->get('id')),$this->getSite());
         }   
         return $this->i18n;
     } 
     ...
     static function getStatusForI18nSelect($site=null)
    {
        ...
        $db=mfSiteDatabase::getInstance()
                ...
                ->setQuery("SELECT ".CustomerContractAdminStatusI18n::getFieldsAndKeyWithTable()." FROM ".CustomerContractAdminStatusI18n::getTable().
