...
class CustomerContractCompanyBaseForm extends mfForm {
    ...
    function configure() {              
        ...
        if ($this->getUser()->hasCredential(array(array('superadmin','contract_company_new_type'))))
           $this->setValidator('type',new mfValidatorChoice(array('key'=>true,'required'=>false,'choices'=>array(''=>'','ISO'=>__("ISO"),'BOILER'=>__("BOILER"),'PAC'=>__("PAC"),'ITE'=>__('ITE'))))); 
    }
