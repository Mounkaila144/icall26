...
const SITE_NAMESPACE = 'system/site';
    ...
    function execute(mfWebRequest $request) {
        ...
        $this->formFilter= new CustomersContractStatusFormFilter($request->getRequestParameter('lang',$request->getPostParameter('lang',$this->getUser()->getCountry())),$this->site);                  
