...
class customers_contracts_ajaxNewStatusI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {              
        ...
        $this->form= new CustomerContractStatusNewForm((string)$form['lang'],array(),$this->site);
        $this->customer_contract_status_i18n=new CustomerContractStatusI18n(array('lang'=>(string)$form['lang']),$this->site);        
    }
