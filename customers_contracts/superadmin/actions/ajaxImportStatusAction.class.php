...
require_once dirname(__FILE__)."/../locales/Import/Status/ContractStatusImport.class.php";


class customers_contracts_ajaxImportStatusAction extends mfAction {
    ...
    {   
        ...
        try
        {              
            $this->form=new ContractStatusImportFileForm($request->getPostParameter('Import'),$this->site);      
           ...
           // $messages->mergeMessages($import->getMessages()); 
            ...
            {                
                ...
                {                                                                             
                   $import=new ContractStatusImport($this->form->getFile(),'zip',$this->site);     
                   $import->execute();
                   $messages->mergeMessages($import->getMessages()); 
