...
class customers_contracts_ajaxSaveNewStatusI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {             
        ...
        try
        {      
            $this->form= new CustomerContractStatusNewForm($this->getUser()->getCountry(),$request->getPostParameter('CustomerContractStatus'),$this->site);             
            $this->customer_contract_status_i18n=new CustomerContractStatusI18n(null,$this->site);
