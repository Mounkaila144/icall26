...
class DomoprimePollutingCompanyFormFilter extends mfFormFilterBase{
    ...
    {                    
       ...
       $this->setClass('PartnerPolluterCompany');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ". PartnerPolluterCompany::getTable().  
                       ";"); 
       // Validators 
