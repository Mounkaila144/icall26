...
class DomoprimeClassFormFilter extends mfFormFilterBase {
    ...
    {                          
       ...
       $this->setClass('DomoprimeClass');
       $this->setFields(array('value'=>'DomoprimeClassI18n'));
       $this->setQuery("SELECT {fields} FROM ".DomoprimeClass::getTable().                      
