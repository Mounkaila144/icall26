...
class DomoprimeBillingForContractFormFilter extends mfFormFilterBase {
    ...
    {                          
       ...
       $this->setQuery("SELECT {fields} FROM ".DomoprimeBilling::getTable().         
                        " LEFT JOIN ".DomoprimeBilling::getOuterForJoin('creator_id').  
                       " WHERE ".DomoprimeBilling::getTableField('contract_id')."='{contract_id}'".
                       ";"); 
       // Validators 
