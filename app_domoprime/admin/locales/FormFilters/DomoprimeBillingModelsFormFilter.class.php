...
class DomoprimeBillingModelsFormFilter extends mfFormFilterBase {
    ...
    {                   
       ...
       $this->setClass('DomoprimeBillingModel');
       $this->setFields(array('value'=>'DomoprimeBillingModelI18n'));
       $this->setQuery("SELECT {fields} FROM ".DomoprimeBillingModel::getTable().                      
                       " LEFT JOIN ".DomoprimeBillingModelI18n::getInnerForJoin('model_id'). " AND ".DomoprimeBillingModelI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
