...
class DomoprimeSubventionTypeFormFilter extends mfFormFilterBase {
    ...
    {                    
       ...
       $this->setClass('DomoprimeSubventionType');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ".DomoprimeSubventionType::getTable().                     
                       ";"); 
       // Validators 
