...
class CustomerMeetingDocumentFieldForDocumentFormFilter extends mfFormFilterBase {
    ...
    {                        
       ...
       $this->setClass('CustomerMeetingFormDocumentFormfield');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ". CustomerMeetingFormDocumentFormfield::getTable(). 
                     ...
                     //  " LEFT JOIN ".DomoprimeCustomerMeetingFormDocumentFormfieldClass::getInnerForJoin('form_document_id').
                    //   " LEFT JOIN ".DomoprimeCustomerMeetingFormDocumentFormfieldClass::getOuterForJoin('class_id').
