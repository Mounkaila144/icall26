...
class DomoprimeEnergyFormFilter extends mfFormFilterBase {
    ...
    {                          
       ...
       $this->setClass('DomoprimeEnergy');
       $this->setFields(array('value'=>'DomoprimeEnergyI18n'));
       $this->setQuery("SELECT {fields} FROM ".DomoprimeEnergy::getTable().                      
