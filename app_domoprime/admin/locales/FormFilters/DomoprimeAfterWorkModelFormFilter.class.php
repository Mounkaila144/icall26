...
class DomoprimeAfterWorkModelFormFilter extends mfFormFilterBase {
    ...
    {                   
       ...
       $this->setClass('DomoprimeAfterWorkModel');
       $this->setFields(array('value'=>'DomoprimeAfterWorkModelI18n'));
       $this->setQuery("SELECT {fields} FROM ".DomoprimeAfterWorkModel::getTable().                      
                       " LEFT JOIN ".DomoprimeAfterWorkModelI18n::getInnerForJoin('model_id'). " AND ".DomoprimeAfterWorkModelI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
