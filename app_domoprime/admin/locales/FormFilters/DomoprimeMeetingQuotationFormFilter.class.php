...
class DomoprimeMeetingQuotationFormFilter extends mfFormFilterBase {
    ...
    /*   $this->setQuery("SELECT {fields} FROM ".DomoprimeQuotation::getTable().  
       ...
       $this->_query->select("{fields}")
                     ...
                     ->inner(DomoprimeQuotation::getOuterForJoin('meeting_id'))
                     ->left(CustomerMeeting::getOuterForJoin('polluter_id'))
               ;
