...
class DomoprimeQuotationForContractFormFilter extends mfFormFilterBase {
    ...
    {                          
       ...
       $this->setQuery("SELECT {fields} FROM ".DomoprimeQuotation::getTable().  
                       ...
                       " WHERE (".DomoprimeQuotation::getTableField('contract_id')."='{contract_id}' OR ".
                                  DomoprimeQuotation::getTableField('meeting_id')."='{meeting_id}')".
