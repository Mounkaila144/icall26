...
class DomoprimePreMeetingModelsFormFilter extends mfFormFilterBase {
    ...
    {               
       ...
       $this->objects=array('DomoprimePreMeetingModelI18n','DomoprimePreMeetingModel');
       ...
       $this->setClass('DomoprimePreMeetingModel');
       $this->setFields(array('value'=>'DomoprimePreMeetingModelI18n'));
       $this->setQuery("SELECT {fields} FROM ".DomoprimePreMeetingModel::getTable().                      
                       " LEFT JOIN ".DomoprimePreMeetingModelI18n::getInnerForJoin('model_id'). " AND ".DomoprimePreMeetingModelI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
