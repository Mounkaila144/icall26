...
class DomoprimeAssetModelsFormFilter extends mfFormFilterBase {
    ...
    {               
       ...
       $this->objects=array('DomoprimeAssetModelI18n','DomoprimeAssetModel');
       ...
       $this->setClass('DomoprimeAssetModel');
       $this->setFields(array('value'=>'DomoprimeAssetModelI18n'));
       $this->setQuery("SELECT {fields} FROM ".DomoprimeAssetModel::getTable().                      
                       " LEFT JOIN ".DomoprimeAssetModelI18n::getInnerForJoin('model_id'). " AND ".DomoprimeAssetModelI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
