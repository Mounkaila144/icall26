...
require_once __DIR__."/Pagers/DomoprimeQuotationApi2Pager.class.php";
require_once __DIR__."/FormFilters/DomoprimeQuotationApi2FormFilter.class.php";
require_once __DIR__."/Formatters/DomoprimeQuotationItemFormatterApi2.class.php";

class DomoprimeQuotationListFormatterApi2 extends mfFormatterActionApi2 {
    ...
    {   
        try
        {            
            $this->formFilter= new DomoprimeQuotationApi2FormFilter($this->getUser());              
          ...
          ///           $this->getFilterWidgets()->pushIf(is_numeric($field)?true:(isset($values[$field]['condition'])?$values[$field]['condition']:true), new mfWidgetFieldApi(is_numeric($field)?$values:$field, is_numeric($field)?array():$values));
            $this->pager=new DomoprimeQuotationApi2Pager($this->formFilter);    
