...
<div>
   <a href="#" id="DomoprimeQuotationForContractNew-Save" class="btn" style="display:none">
        <i class="fa fa-floppy-o" style="color:#000; margin-right:10px;"></i>{__('Save')}</a>
    <a href="#" id="DomoprimeQuotationForContractNew-Cancel" class="btn">
...
{foreach $form->getProducts() as $product}    
    ...
    <tr>
        <td>  
            {__('Quantity')}
             <input  type="text" class="DomoprimeQuotationForContract Products-{$product->get('id')} Fields" value="{$form.products[$product@index]['quantity']}" name="quantity"/>
        </td>
    </tr> 
    <tr>
        <td>
...
<script type="text/javascript">
   ...
   $(".DomoprimeQuotationForContract.Date").datepicker();
          ...
          $(".DomoprimeQuotationForContract.Fields").click(function () {   $("#DomoprimeQuotationForContractNew-Save").show();   });
            
          {* =====================  P A G E R  A C T I O N S =============================== *}  
      
           $("#DomoprimeQuotationForContractNew-Cancel").click(function() {                  
               return $.ajax2({                     
       ...
       $('#DomoprimeQuotationForContractNew-Save').click(function(){                             
