...
<script type="text/javascript">
     ...
     $('#CustomerModelEmail-Cancel').click(function(){              
      ...
      $('#CustomerModelEmail-Save').click(function(){                             
          ...
          $("input.CustomerModelEmailI18n,textarea.CustomerModelEmailI18n").each(function() { params.DomoprimeAssetModel.model_i18n[this.name]=$(this).val(); });
          $("input.CustomerModelEmail").each(function() {  params.DomoprimeAssetModel.model[this.name]=$(this).val();  });  // Get foreign key  
        //      alert("Params="+params.toSource());   return ;          
          return $.ajax2({ data : params,                        
                           url: "{url_to('app_domoprime_ajax',['action'=>'SaveNewAssetModelI18n'])}",
                           errorTarget: ".site-errors",
                           target: "#actions"}); 
        });  
