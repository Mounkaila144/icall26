...
<h3>{__("View contact for polluting: %s.",$item->getCompany()->get('name'))}</h3>
<div>
...
<table class="tab-form">
    ...
    <tr>
        ...
        <td class="label">
             ...
             <input type="text" class="PollutingContact" name="firstname" size="64" value="{$item->get('firstname')}"/> 
    ...
    <tr>
        ...
        <td class="label">
             ...
             <input type="text" class="PollutingContact" name="lastname" size="64" value="{$item->get('lastname')}"/> 
    ...
    <tr>
     ...
     <td class="label"> 
         ...
         <input type="text" class="PollutingContact" name="email" size="64" value="{$item->get('email')|escape}" size="30"/>
 ...
 <tr>
     ...
     <td class="label"> 
         ...
         <input type="text" class="PollutingContact" name="phone" value="{$item->get('phone')|escape}" size="30"/>
 ...
 <tr>
     ...
     <td class="label"> 
         ...
         <input type="text" class="PollutingContact" name="mobile" value="{$item->get('mobile')|escape}" size="30"/>
  ...
  <tr>
     ...
     <td class="label"> 
         ...
         <input type="text" class="PollutingContact" name="fax" value="{$item->get('fax')|escape}" size="30"/>
...
<script type="text/javascript">
     ...
     $('#PollutingContact-Cancel').click(function(){                           
      ...
      $('#PollutingContact-Save').click(function(){                             
          ...
          $("input.PollutingContact[type=text]").each(function() {  params.PollutingContact[this.name]=$(this).val();  });  // Get foreign key                  
          $("input.PollutingContact[type=radio]:checked").each(function() { params.PollutingContact[this.name]=$(this).val(); }); 
          return $.ajax2({ data : params,                            
                           errorTarget: ".Polluting-errors",
                           url: "{url_to('app_domoprime_ajax',['action'=>'SavePollutingContact'])}",
                           target: "#actions" }); 
        });  
