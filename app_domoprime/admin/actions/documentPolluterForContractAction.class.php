...
class app_domoprime_documentPolluterForContractAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {            
      ...
      {                        
          ...
          if ($contract->isNotLoaded())
             $this->forward404File();                    
          $polluter_document=new PartnerPolluterDocument($request->getRequestParameter('document'));         
