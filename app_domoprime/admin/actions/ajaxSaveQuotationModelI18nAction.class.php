...
class  app_domoprime_ajaxSaveQuotationModelI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                  
        ...
        $this->form = new DomoprimeQuotationModelViewForm($request->getPostParameter('DomoprimeQuotationModelI18n'));                    
        try
        {            
            $this->item_i18n=new DomoprimeQuotationModelI18n($this->form->getDefault('model_i18n'));               
            $this->form->bind($request->getPostParameter('DomoprimeQuotationModelI18n'));                            
