<?php
// www.ecosol16.net/admin/api/v2/applications/iso/admin/ExportPdfQuotationFromContract
...
class app_domoprime_api2ExportPdfQuotationFromContractAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {
        ...
        if (!$this->getUser()->hasCredential([['superadmin', 'api_v2_app_domoprime_quotation_from_contract_export_pdf']]))
