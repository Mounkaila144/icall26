...
class app_domoprime_ajaxSaveClassI18nForPriceAction extends mfAction{
    ...
    function execute(mfWebRequest $request) {
        ...
        $this->form = new DomoprimeClassViewForm($request->getPostParameter('DomoprimeClassI18n'));                    
        try
        {            
            ...
            {              
                ...
                $this->forward('app_domoprime','ajaxListPartialClassForPrice');
            }   
            else
            {                    
