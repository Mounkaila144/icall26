...
class DomoprimeAssetModelI18nBase extends mfObjectI18n {
     
    protected static $fields=array('value','model_id','lang','body','created_at','updated_at');
    const table="t_domoprime_asset_model_i18n"; 
    protected static $foreignKeys=array('model_id'=>'DomoprimeAssetModel'); // By default
  ...
  /*  protected function loadByEmail($email)
     ...
     function getModel()
    {
       if (!$this->_model_id)
       {
          $this->_model_id=new DomoprimeAssetModel($this->get('model_id'),$this->getSite());          
       }   
