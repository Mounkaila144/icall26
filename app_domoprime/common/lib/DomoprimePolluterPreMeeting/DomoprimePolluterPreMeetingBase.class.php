...
class DomoprimePolluterPreMeetingBase extends mfObject2 {
     
    protected static $fields=array('model_id','polluter_id','created_at','updated_at');
    
    const table="t_partner_polluter_pre_meeting"; 
       protected static $foreignKeys=array('model_id'=>'DomoprimePreMeetingModel',                                           
