...
class DomoprimeQuotationModelI18nBase extends mfObjectI18n {
     
    protected static $fields=array('value','model_id','lang','body','initiator_signature','signature','created_at','updated_at');
    const table="t_domoprime_quotation_model_i18n"; 
    protected static $foreignKeys=array('model_id'=>'DomoprimeQuotationModel'); // By default
  ...
  /*  function getVariables()
    ...
    function getUsedVariables(){
        ...
        $matches=array();        
        preg_match_all('/\{\$(([a-zA-Z0-9]+(\.[a-zA-Z0-9]+(\_*[a-zA-Z0-9]*)*)*)(\|[a-zA-Z0-9]+)?)\}/', $this->get('body'), $matches); 
        sort($matches[2]);        
    ...
    function getSignatures()
    {
        ...
        {
            $this->_signature=new DomoprimeQuotationModelSignatureCollection($this->get('signature'));
        }
    ...
    function getInitiatorSignature()
    {
        ...
        {
            $this->_initiator_signature=new DomoprimeQuotationModelSignature($this->get('initiator_signature'));
        }
    ...
    function getInitiatorSignatures()
    {
        ...
        {
            $this->_initiator_signatures=new DomoprimeQuotationModelSignatureCollection($this->get('initiator_signature'));
        }
