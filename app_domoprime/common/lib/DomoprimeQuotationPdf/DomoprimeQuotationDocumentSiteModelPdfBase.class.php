...
class DomoprimeQuotationDocumentSiteModelPdfBase extends SystemPdftk {
    
    protected $model=null,$contract=null,$action=null,$site=null;
    public       $data=null;
    
    function __construct(CustomerContract $contract, SiteCompanyModel $model)
    {        
       $this->model=$model;
    ...
    function getPath()
    {
        return mfConfig::get('mf_site_app_cache_dir')."/data/pdf/contracts/".$this->contract->get('id')."/documents/".session_id()."/company";
    }
    ...
    {                
        ...
        {
           echo "<pre> SITE MODEL "; var_dump($this->action->getVariables()->flatten()); echo "</pre>"; die(__METHOD__); 
        }    
