...
class DomoprimeQuotationCollection extends mfObjectCollection2 {
    ...
    function  createBillings($user)
    {       
        foreach ($this->collection as $item)
        {
           $billing=new DomoprimeBilling(null,$this->getSite());
           $billing->createFromQuotation($item->contract,$item,$user);           
        }  
        return $this;
    }
