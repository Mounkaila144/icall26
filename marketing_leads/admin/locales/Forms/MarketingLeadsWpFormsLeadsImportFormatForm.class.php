...
require_once dirname(__FILE__).'/../Imports/Forms/MarketingLeadsWpFormsAllLeadsImportForm.class.php';

class MarketingLeadsWpFormsLeadsImportFieldFormatImport extends mfForm {
...
class MarketingLeadsWpFormsLeadsImportFormatForm extends mfForm {
    ...
    function configure() { 
        $this->form=new MarketingLeadsWpFormsAllLeadsImportForm($this->getUser());        
        $this->setValidators(array(
            'name'=>new mfValidatorString()
        ));
        $this->embedFormForEach('fields', new MarketingLeadsWpFormsLeadsImportFieldFormatImport(),count($this->getDefault('fields')));
