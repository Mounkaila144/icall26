...
class MarketingLeadsWpFormsStatusNewForm extends mfForm {
    ...
    function configure()
    {
        ...
        $this->embedForm('status_i18n', new MarketingLeadsWpFormsStatusI18nBaseForm($this->getDefault('status_i18n')));
