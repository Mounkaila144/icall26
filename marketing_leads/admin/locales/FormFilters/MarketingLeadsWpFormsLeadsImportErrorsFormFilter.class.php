...
class MarketingLeadsWpFormsLeadsImportErrorsFormFilter extends mfFormFilterBase {
    ...
    { 
        ...
        $this->setClass('MarketingLeadsWpFormsLeadsImportErrors');
        $this->setFields(array());
        $this->setQuery("SELECT * FROM ".MarketingLeadsWpFormsLeadsImportErrors::getTable(). 
