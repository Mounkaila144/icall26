...
class MarketingLeadsWpFormsStatusFormFilter extends mfFormFilterBase {
    ...
    {                   
        ...
        $this->setClass('MarketingLeadsWpFormsStatus');
        $this->setFields(array('value'=>'MarketingLeadsWpFormsStatusI18n'));
        $this->setQuery("SELECT {fields} FROM ".MarketingLeadsWpFormsStatus::getTable().                      
                        " LEFT JOIN ".MarketingLeadsWpFormsStatusI18n::getInnerForJoin('status_id'). " AND ".MarketingLeadsWpFormsStatusI18n::getTableField('lang')."='{lang}'".                                                        
                        ";"); 
        // Validators 
