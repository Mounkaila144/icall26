...
class MarketingLeadsWpFormsLeadsImportFormatFormFilter extends mfFormFilterBase {
    ...
    {                   
        ...
        $this->setClass('MarketingLeadsWpFormsLeadsImportFormat');
        $this->setFields(array());
        $this->setQuery("SELECT * FROM ".MarketingLeadsWpFormsLeadsImportFormat::getTable().                                            
                        ";"); 
        // Validators 
