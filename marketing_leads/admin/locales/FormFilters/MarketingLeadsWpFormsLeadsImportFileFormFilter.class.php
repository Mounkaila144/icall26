...
class MarketingLeadsWpFormsLeadsImportFileFormFilter extends mfFormFilterBase {      
    ...
    function configure()
    {
        ...
        $this->setClass('MarketingLeadsWpFormsLeadsImportFile');
        $this->setFields(array());
        $this->setQuery("SELECT {fields} FROM ".MarketingLeadsWpFormsLeadsImportFile::getTable(). 
                        " INNER JOIN ".MarketingLeadsWpFormsLeadsImportFile::getOuterForJoin("user_id").
                        ";"); 
        // Validators 
