{messages class="MarketingLeadsWpLandingPageSite-errors"}
<h3>{__("New")}</h3>
<div>
    <a href="#" id="MarketingLeadsWpLandingPageSite-Save" class="btn" style="display:none"><i class="fa fa-floppy-o" style="color:#000; margin-right:10px;"></i>{__('Save')}</a>
    <a href="#" id="MarketingLeadsWpLandingPageSite-Cancel" class="btn"><i class="fa fa-times" style="color:#000;margin-right:10px;"></i>{__('Cancel')}</a>
</div>

<table class="tab-form" cellpadding="0" cellspacing="0"> 
    <tr> {*//'host_site','host_db','name_db','user_db','password_db','campaign'*}
...
<script type="text/javascript">
    ...
    $('#MarketingLeadsWpLandingPageSite-Cancel').click(function(){
        return $.ajax2({ data: { filter: { lang:$("img.MarketingLeadsWpLandingPageSite").attr('id'), token: "{mfForm::getToken('MarketingLeadsWpLandingPageSiteFormFilter')}" } },                              
