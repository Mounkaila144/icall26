{messages class="MarketingLeadsWpForms-view-errors"}
<h3>{__("View form")}</h3>
{if $item->isLoaded()} 
<div>
    <a href="#" id="MarketingLeadsWpForms-Save" class="btn" style="display:none"><i class="fa fa-floppy-o" style="color:#000; margin-right:10px;"></i>{__('Save')}</a>
    <a href="#" id="MarketingLeadsWpForms-Cancel" class="btn"><i class="fa fa-times" style="color:#000;margin-right:10px;"></i>{__('Cancel')}</a>
</div>
...
<script type="text/javascript">
    ...
    $('#MarketingLeadsWpForms-Cancel').click(function(){                           
        return $.ajax2({ data: { WpLandingPageSite: {$landing_page_site->get('id')} },                           
                        ...
                        errorTarget: ".MarketingLeadsWpForms-view-errors",
    ...
    $('#MarketingLeadsWpForms-Save').click(function(){                             
        ...
        return $.ajax2({ data : params,  
                        errorTarget: ".MarketingLeadsWpForms-view-errors",
                        url: "{url_to('marketing_leads_ajax',['action'=>'SaveWpForms'])}",
                        loading: "#tab-site-dashboard-marketing-leads-loading",
                        target: "#actions-wp-landing-page-site-list"
                    }); 
    });  
