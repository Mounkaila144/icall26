...
class ServiceForServicesFormFilter extends mfFormFilterBase {
    ...
    function configure()
    {
       ...
       $this->setQuery("SELECT * FROM ".SiteServicesSite::getTable().  
                 ";"); 
       // Validators 
    ...
    function execute()
    {
        ...
        {   
            $this->items[$item->get('id')]=$item->toArray(array());                     
        }       
    }
