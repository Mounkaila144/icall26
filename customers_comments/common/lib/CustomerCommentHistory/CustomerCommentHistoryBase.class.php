...
class CustomerCommentHistoryBase extends mfObject2 {
     
    protected static $fields=array('user_id','user_application','comment_id','updated_at','created_at');
    const table="t_customers_comments_history"; 
    protected static $foreignKeys=array('user_id'=>'User','comment_id'=>'CustomerComment'); // By default
  ...
  /*  public function getDirectory()
     ...
     function getComment()
    {
       if (!$this->_comment_id)
       {
          $this->_comment_id=new CustomerComment($this->get('comment_id'),$this->getSite());          
       }   
