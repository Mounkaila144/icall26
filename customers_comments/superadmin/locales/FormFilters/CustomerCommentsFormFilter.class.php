...
class CustomerCommentsFormFilter extends mfFormFilterBase {
    ...
    function configure()
    {                   
       $this->objects=array('CustomerCommentHistory','CustomerComment','User');
       ...
       $this->setQuery("SELECT {fields} FROM ".CustomerCommentHistory::getTable().                      
                       " LEFT JOIN ".CustomerCommentHistory::getOuterForJoin('comment_id'). 
                       " LEFT JOIN ".CustomerCommentHistory::getOuterForJoin('user_id'). 
                       " WHERE ".CustomerComment::getTableField('customer_id')."={customer_id}".
                       ";"); 
       // Validators 
