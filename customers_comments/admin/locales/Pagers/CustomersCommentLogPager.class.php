...
class CustomersCommentLogPager extends Pager {

    function __construct() {
        parent::__construct(array('CustomerComment','CustomerCommentHistory','User','Customer'));
    }
    ...
    {          
       ...
       {                       
           ...
           $items->getCustomerCommentHistory()->getComment()->set('customer_id',$items->getCustomer());
           if ($items->hasUser())
