...
class customers_comments_ajaxSettingsAction extends mfAction {
    ...
    function execute(mfWebRequest $request)
    {
        ...
        $this->settings= new CustomerCommentSettings();        
        $this->form=new CustomerCommentSettingsForm($this->getUser());                 
