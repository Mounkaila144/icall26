...
CREATE TABLE IF NOT EXISTS `t_partner_layer_company`(
...
--
-- Structure de la table `t_partner_layer_contact`
--

CREATE TABLE IF NOT EXISTS `t_partner_layer_contact` (
...
ALTER TABLE `t_partner_layer_contact` ADD CONSTRAINT `partner_layer_contact_1` FOREIGN KEY (`company_id`) REFERENCES `t_partner_layer_company` (`id`) ON DELETE CASCADE;
