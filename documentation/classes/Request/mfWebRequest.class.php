...
class mfWebRequest { 
	...
	protected function _getForcedCulture();
	...
	protected function fixFilesArray($data);
	...
	public function getRequestRequestParameter($name,$default=null);
	public function getRequestRequestParameters();
	public function getGetAndPostParameters();
	public function getGetAndPostParameter($name,$default=null);
}
