...
<div id="oversight-dashboard-tabs" style="margin-top: 15px;">
         <ul>       
            <li class="tabs-sites">               
                <a href="#tab-oversight-dashboard-tab1">                
                     <span>{__('Contract')}</span>                    
                </a>                            
            </li>     
            <li class="tabs-sites">               
                <a href="#tab-oversight-dashboard-tab2">                
                     <span>{__('Customer')}</span>                    
                </a>                            
            </li>             
         </ul>      
        <div id="tab-oversight-dashboard-tab1">
            <div>tab1</div>
               tab-oversight-dashboard-tab1
        </div>
        <div id="tab-oversight-dashboard-tab2">
            <div>tab2</div>
            tab-oversight-dashboard-tab2
        </div>
    </div>

<h3>{__("Oversight")}</h3>
<div>    
   {* <a href="#" id="SiteOversightMessageProcess" class="btn">
...
<script type="text/javascript">
 ...
 {* =================== A C T I O N S ================================ *}     
    ...
    $("#SiteOversightMessageProcess").click(function(){                  
        return $.ajax2({ 
    ...
    $("#SiteOversightMessageSend").click(function(){                  
        return $.ajax2({ 
